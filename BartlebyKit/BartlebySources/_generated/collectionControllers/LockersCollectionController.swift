...
@objc(LockersCollectionController) public class LockersCollectionController : BaseObject,IterableCollectibleCollection{
...
// MARK: Identifiable
    ...
    required public init?(coder decoder: NSCoder) {
		...
		items=decoder.decodeObjectOfClasses(NSSet(array: [NSArray.classForCoder(),Locker.classForCoder()]), forKey: "items")! as! [Locker]
		_startObservingAllItems()
