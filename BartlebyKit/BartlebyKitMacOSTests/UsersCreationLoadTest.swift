...
class UsersCreationLoadTest: TestCase {
    ...
    fileprivate func _create_a_user(_ completionHandler: @escaping (_ createdUser: User, _ completionState: Completion) -> Void, idMethod: DocumentMetadata.IdentificationMethod) {
    ...
    fileprivate func _run_test_routine_implementation(_ expectation: XCTestExpectation, idMethod: DocumentMetadata.IdentificationMethod) {
        ...
        func __create(_ idMethod: DocumentMetadata.IdentificationMethod) {
            _create_a_user({ user, completionState in
        ...
        func __update(_ user: User) {
            ...
            UpdateUser.execute(user, in: UsersCreationLoadTest.document.UID, sucessHandler: { _ in
                __delete(user)
            }) { context in
                __fullFill()
        ...
        func __delete(_ user: User) {
            DeleteUser.execute(user, from: UsersCreationLoadTest.document.UID, sucessHandler: { _ in
                __isItTheEnd()
                // __logout(user)
            }) { context in
                __fullFill()
    ...
    func test_001_1X1_key() {
        ...
        _run_test_routine_implementation(expectation, idMethod: DocumentMetadata.IdentificationMethod.key)
    ...
    func test_002_1X1_cookie() {
        ...
        _run_test_routine_implementation(expectation, idMethod: DocumentMetadata.IdentificationMethod.cookie)
        waitForExpectations(timeout: TestsConfiguration.LONG_TIME_OUT_DURATION, handler: nil)
    }
