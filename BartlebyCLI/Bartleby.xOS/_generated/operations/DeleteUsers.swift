...
@objc(DeleteUsers) public class DeleteUsers : BartlebyObject,BartlebyOperation{
    ...
    */
    init (_ users:[User]=[User](), from documentUID:String) {
        self._users=users
    ...
    */
    static func commit(_ users:[User], from documentUID:String){
        let operationInstance=DeleteUsers(users,from:documentUID)
    ...
    func commit(){
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(self._documentUID) {
            ...
            do{
				...
				pushOperation.summary="DeleteUsers(\(stringIDS))"
    ...
    open func push(sucessHandler success:@escaping (_ context:HTTPContext)->(),
        ...
        if  pushOperation.canBePushed(){
            ...
            DeleteUsers.execute(self._users,
