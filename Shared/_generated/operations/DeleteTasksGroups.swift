...
import ObjectMapper
#endif
@objc(DeleteTasksGroups) public class DeleteTasksGroups : BaseObject,JHTTPCommand{
    ...
    */
    static func commit(ids:[String], fromDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=DeleteTasksGroups(ids,fromDataSpace:spaceUID,observableBy:observationUID)
        operationInstance.commit()
    }


    func commit(){
        let context=Context(code:328176962, caller: "DeleteTasksGroups.commit")
    ...
    public func push(sucessHandler success:(context:HTTPResponse)->(),
        ...
        if let _ = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            ...
            if  self._operation.status==Operation.Status.Pending ||
                ...
                DeleteTasksGroups.execute(self._ids,
                ...
                // This registry is not available there is nothing to do.
                let context=Context(code:4241099017, caller: "DeleteTasksGroups.push")
                Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
...
fromDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                parameters["ids"]=ids
                let urlRequest=HTTPManager.mutableRequestWithToken(inDataSpace:spaceUID,withActionName:"DeleteTasksGroups" ,forMethod:"DELETE", and: pathURL)
                ...
                r.responseString{ response in
                    ...
                    let context = JHTTPResponse( code: 3482039436,
                        caller: "DeleteTasksGroups.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("deleteByIds  of tasksGroups",
                            comment: "deleteByIds of tasksGroups failure description")
