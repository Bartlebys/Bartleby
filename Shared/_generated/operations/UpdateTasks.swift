...
import ObjectMapper
#endif
@objc(UpdateTasks) public class UpdateTasks : BaseObject,JHTTPCommand{
    ...
    */
    static func commit(tasks:[Task], inDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=UpdateTasks(tasks,inDataSpace:spaceUID,observableBy:observationUID)
        operationInstance.commit()
    }


    func commit(){
        let context=Context(code:2868188268, caller: "UpdateTasks.commit")
    ...
    public func push(sucessHandler success:(context:HTTPResponse)->(),
        ...
        if let _ = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            ...
            if  self._operation.status==Operation.Status.Pending ||
                ...
                UpdateTasks.execute(self._tasks,
                ...
                // This registry is not available there is nothing to do.
                let context=Context(code:3314294104, caller: "UpdateTasks.push")
                Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
...
inDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inDataSpace:spaceUID,withActionName:"UpdateTasks" ,forMethod:"PUT", and: pathURL)
                ...
                r.responseString{ response in
                    ...
                    let context = JHTTPResponse( code: 333759426,
                        caller: "UpdateTasks.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("update  of tasks",
                            comment: "update of tasks failure description")
