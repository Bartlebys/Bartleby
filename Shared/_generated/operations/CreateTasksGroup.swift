...
import ObjectMapper
#endif
@objc(CreateTasksGroup) public class CreateTasksGroup : BaseObject,JHTTPCommand{
    ...
    public func push(sucessHandler success:(context:HTTPResponse)->(),
        ...
        if let registry = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            ...
            if  self._operation.status==Operation.Status.Pending ||
                ...
                CreateTasksGroup.execute(self._tasksGroup,
                    inDataSpace:self._spaceUID,
                    sucessHandler: { (context: JHTTPResponse) -> () in
                        registry.markAsDistributed(&self._tasksGroup)
...
inDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                r.responseString{ response in
                    ...
                    let context = JHTTPResponse( code: 628498132,
                        caller: "CreateTasksGroup.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("creation  of tasksGroup",
                            comment: "creation of tasksGroup failure description")
