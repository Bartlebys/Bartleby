...
import ObjectMapper
#endif
@objc(DeleteTasks) public class DeleteTasks : BaseObject,JHTTPCommand{
    ...
    */
    static func commit(ids:[String], fromDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=DeleteTasks(ids,fromDataSpace:spaceUID,observableBy:observationUID)
        operationInstance.commit()
    }


    func commit(){
        let context=Context(code:1905553736, caller: "DeleteTasks.commit")
    ...
    public func push(sucessHandler success:(context:HTTPResponse)->(),
        ...
        if let _ = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            ...
            if  self._operation.status==Operation.Status.Pending ||
                ...
                // This registry is not available there is nothing to do.
                let context=Context(code:164030259, caller: "DeleteTasks.push")
                Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
...
fromDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                parameters["ids"]=ids
                let urlRequest=HTTPManager.mutableRequestWithToken(inDataSpace:spaceUID,withActionName:"DeleteTasks" ,forMethod:"DELETE", and: pathURL)
                ...
                r.responseString{ response in
                    ...
                    let context = JHTTPResponse( code: 792479350,
                        caller: "DeleteTasks.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("deleteByIds  of tasks",
                            comment: "deleteByIds of tasks failure description")
