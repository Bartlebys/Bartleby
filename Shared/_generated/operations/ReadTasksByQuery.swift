...
@objc(ReadTasksByQuery) public class ReadTasksByQuery : BaseObject{
    ...
    public static func execute(fromDataSpace spaceUID:String,
				    ...
				    let pathURL=baseURL.URLByAppendingPathComponent("tasksByQuery")
				    let dictionary:Dictionary<String, AnyObject>?=Mapper().toJSON(parameters)
				    let urlRequest=HTTPManager.mutableRequestWithToken(inDataSpace:spaceUID,withActionName:"ReadTasksByQuery" ,forMethod:"POST", and: pathURL)
				    ...
				    r.responseJSON{ response in
				        ...
				        let context = JHTTPResponse( code: 2654226716,
				            caller: "ReadTasksByQuery.execute",
