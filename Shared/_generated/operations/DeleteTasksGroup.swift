...
@objc(DeleteTasksGroup) public class DeleteTasksGroup : BaseObject,JHTTPCommand{
    ...
    override public func mapping(map: Map) {
        super.mapping(map)
		_tasksGroupId <- map["_tasksGroupId"]
    ...
    required public init?(coder decoder: NSCoder) {
		...
		_tasksGroupId=String(decoder.decodeObjectOfClass(NSString.self, forKey: "_tasksGroupId")! as NSString)
    ...
    override public func encodeWithCoder(coder: NSCoder) {
		...
		coder.encodeObject(_tasksGroupId,forKey:"_tasksGroupId")
