...
import ObjectMapper
#endif
@objc(UpdateTasksGroup) public class UpdateTasksGroup : BaseObject,JHTTPCommand{
    ...
    required public init?(coder decoder: NSCoder) {
		...
		_tasksGroup=decoder.decodeObjectOfClass(TasksGroup.self, forKey: "_tasksGroup")! 
    ...
    override public func encodeWithCoder(coder: NSCoder) {
		...
		coder.encodeObject(_tasksGroup,forKey:"_tasksGroup")
    ...
    - parameter tasksGroup: the tasksGroup concerned the operation
    ...
    */
    ...
    - parameter tasksGroup: the instance
    - parameter spaceUID:     the space UID
    ...
    */
    static func commit(tasksGroup:TasksGroup, inDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=UpdateTasksGroup(tasksGroup,inDataSpace:spaceUID,observableBy:observationUID)
        operationInstance.commit()
    }


    func commit(){
        let context=Context(code:1716538094, caller: "UpdateTasksGroup.commit")
    ...
    public func push(sucessHandler success:(context:HTTPResponse)->(),
        ...
        if let _ = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            ...
            if  self._operation.status==Operation.Status.Pending ||
                ...
                UpdateTasksGroup.execute(self._tasksGroup,
                ...
                // This registry is not available there is nothing to do.
                let context=Context(code:1345714868, caller: "UpdateTasksGroup.push")
                Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
...
inDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inDataSpace:spaceUID,withActionName:"UpdateTasksGroup" ,forMethod:"PUT", and: pathURL)
                ...
                r.responseString{ response in
                    ...
                    let context = JHTTPResponse( code: 278824080,
                        caller: "UpdateTasksGroup.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("update  of tasksGroup",
                            comment: "update of tasksGroup failure description")
