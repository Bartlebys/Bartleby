...
@objc(DeleteGroup) public class DeleteGroup : BaseObject,JHTTPCommand{
    ...
    required public init?(coder decoder: NSCoder) {
		...
		self._groupId=String(decoder.decodeObjectOfClass(NSString.self, forKey: "_groupId")! as NSString)
    ...
    override public func encodeWithCoder(coder: NSCoder) {
		...
		coder.encodeObject(self._groupId,forKey:"_groupId")
