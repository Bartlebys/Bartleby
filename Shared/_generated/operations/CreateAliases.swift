...
@objc(CreateAliases) public class CreateAliases : BaseObject,JHTTPCommand{
    ...
    required public init?(coder decoder: NSCoder) {
		...
		self._aliases=decoder.decodeObjectOfClasses(NSSet(array: [NSArray.classForCoder(),Alias.classForCoder()]), forKey: "_aliases")! as! [Alias]
    ...
    override public func encodeWithCoder(coder: NSCoder) {
		...
		coder.encodeObject(self._aliases,forKey:"_aliases")
