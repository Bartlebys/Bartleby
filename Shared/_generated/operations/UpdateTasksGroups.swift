...
@objc(UpdateTasksGroups) public class UpdateTasksGroups : BaseObject,JHTTPCommand{
    ...
    required public init?(coder decoder: NSCoder) {
		...
		_tasksGroups=decoder.decodeObjectOfClasses(NSSet(array: [NSArray.classForCoder(),TasksGroup.classForCoder()]), forKey: "_tasksGroups")! as! [TasksGroup]
    ...
    override public func encodeWithCoder(coder: NSCoder) {
		...
		coder.encodeObject(_tasksGroups,forKey:"_tasksGroups")
