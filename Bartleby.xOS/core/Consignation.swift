...
public protocol Consignation {
    /**
     ...
     - returns: nil
     */
    func presentInteractiveMessage(_ title: String, body: String, onSelectedIndex: @escaping (_ selectedIndex: UInt) -> Void) -> Void
    ...
    /**
     ...
     - returns: nil
     */
    func presentVolatileMessage(_ title: String, body: String) -> Void
    ...
    /**
     ...
     - returns: nil
     */
    func putMessageInLogs(_ title: String, body: String) -> Void
}
...
public protocol AdaptiveConsignation {
    /**
     ...
     - returns: nil
     */
    func dispatchAdaptiveMessage(_ context: Consignable, title: String, body: String, onSelectedIndex: @escaping (_ selectedIndex: UInt) -> Void) -> Void
}
