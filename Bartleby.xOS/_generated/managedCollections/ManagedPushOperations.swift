...
@objc open class ManagedPushOperations : ManagedModel,IterableCollectibleCollection{
    ...
    // The underlining "pushOperations" storage
    ...
    */
    ...
    open weak var arrayController:NSArrayController? {
        ...
        didSet{
            ...
            if let data = self.referentDocument?.metadata.statesDictionary[self.selectedPushOperationsIndexesKey]{
        ...
        didSet{
            Bartleby.syncOnMain {
                if let pushOperations = selectedPushOperations {
                    ...
                    self.referentDocument?.metadata.statesDictionary[selectedPushOperationsIndexesKey] = encodedIndexes
                }
