...
@objc(NodesManagedCollection) open class NodesManagedCollection : BartlebyObject,IterableCollectibleCollection{
    ...
    required public init(items:[Node]) {
        super.init()
        self._items=items
