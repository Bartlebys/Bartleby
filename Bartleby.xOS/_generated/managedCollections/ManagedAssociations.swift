...
@objc(ManagedAssociations) open class ManagedAssociations : ManagedModel,IterableCollectibleCollection{
    ...
    // Stagged "associations" identifiers
    fileprivate dynamic var _staged=[String]()

    // The underling "associations" storage
    fileprivate dynamic var _items:[Association]=[Association](){
        didSet {
    ...
    */
    ...
    override open func setExposedValue(_ value:Any?, forKey key: String) throws {
        switch key {
            case "_items":
                if let casted=value as? [Association]{
                    self._items=casted
                }
            case "_staged":
    ...
    required public init?(coder decoder: NSCoder) {
        ...
        self.quietChanges {
			self._items=decoder.decodeObject(of: [NSArray.classForCoder(),Association.classForCoder()], forKey: "_items")! as! [Association]
        ...
        if let item = item as? Association{
            ...
            if let arrayController = self.arrayController{
                ...
                if let tableView = self.tableView{
                    Async.main{
                        let sorted=self.arrayController?.arrangedObjects as! [Association]
