    ...
    */
    ...
    open weak var arrayController:NSArrayController? {
        ...
        didSet{
            ...
            if let data = self.referentDocument?.metadata.statesDictionary[self.selectedBoxesIndexesKey]{
        ...
        didSet{
            Bartleby.syncOnMain {
                if let boxes = selectedBoxes {
                    ...
                    self.referentDocument?.metadata.statesDictionary[selectedBoxesIndexesKey] = encodedIndexes
                }
