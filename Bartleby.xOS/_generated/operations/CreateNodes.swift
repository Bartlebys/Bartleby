...
@objc(CreateNodes) public class CreateNodes : BartlebyObject,BartlebyOperation{
    ...
    */
    static func commit(_ nodes:[Node], in document:BartlebyDocument){
        ...
        operationInstance._payload=nodes.toJSONString() ?? Default.VOID_STRING
    ...
    open func push(sucessHandler success:@escaping (_ context:HTTPContext)->(),
        ...
        if let nodes = Mapper <Node>().mapArray(JSONString:self._payload){
            do{
            ...
            glog("nodes should not be nil", file: #file, function: #function, line: #line, category: Default.LOG_DEVELOPER_CATEGORY, decorative: false)
        }
    }
