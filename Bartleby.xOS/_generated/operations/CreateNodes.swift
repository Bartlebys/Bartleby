...
@objc public class CreateNodes: ManagedModel, BartlebyOperation {
    ...
    static func commit(_ nodes: [Node], in document: BartlebyDocument) {
        ...
        let context = Context(code: 1_234_672_191, caller: "\(operationInstance.runTimeTypeName()).commit")
        do {
    ...
    open func push(sucessHandler success: @escaping (_ context: HTTPContext) -> Void,
        ...
        do {
            let nodes = try JSON.decoder.decode([Node].self, from: _payload ?? Data())
            ...
            if pushOperation.canBePushed() {
                ...
                referentDocument?.log("CreateNodes can't be pushed \(pushOperation.status)", file: #file, function: #function, line: #line, category: Default.LOG_FAULT, decorative: false)
            }
        } catch {
    ...
    internal func _getOperation() throws -> PushOperation {
        if let document = Bartleby.sharedInstance.getDocumentByUID(self.documentUID) {
            ...
            throw BartlebyOperationError.operationNotFound(UID: "CreateNodes: \(UID)")
        }
        throw BartlebyOperationError.documentNotFound(documentUID: "CreateNodes: \(documentUID)")
    }
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
            ...
            do {
                ...
                request(r).responseJSON(completionHandler: { response in
                    ...
                    let context = HTTPContext(code: 3_781_533_954,
                                              caller: "CreateNodes.execute",
