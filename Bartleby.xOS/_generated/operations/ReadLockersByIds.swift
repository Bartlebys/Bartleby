...
import Foundation
    ...
    import Alamofire
#endif
@objc public class ReadLockersByIdsParameters: ManagedModel {
...
@objc(ReadLockersByIds) open class ReadLockersByIds: ManagedModel {
    ...
    public static func execute(from documentUID: String,
                               ...
                               sucessHandler success: @escaping (_ lockers: [Locker]) -> Void,
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
            ...
            do {
                ...
                request(r).responseData(completionHandler: { response in
                    ...
                    let context = HTTPContext(code: 4_065_884_111,
                    ...
                    metrics.operationName = "ReadLockersByIds"
                        ...
                        if 200 ... 299 ~= statusCode {
                            do {
                                if let data = response.data {
                                    let instance = try JSON.decoder.decode([Locker].self, from: data)
                                    success(instance)
                                } else {
