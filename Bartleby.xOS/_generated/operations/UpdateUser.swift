...
@objc public class UpdateUser: ManagedModel, BartlebyOperation {
    ...
    static func commit(_ user: User, in document: BartlebyDocument) {
        ...
        let context = Context(code: 933_151_040, caller: "\(operationInstance.runTimeTypeName()).commit")
        do {
    ...
    open func push(sucessHandler success: @escaping (_ context: HTTPContext) -> Void,
        ...
        do {
            ...
            if pushOperation.canBePushed() {
                ...
                referentDocument?.log("UpdateUser can't be pushed \(pushOperation.status)", file: #file, function: #function, line: #line, category: Default.LOG_FAULT, decorative: false)
            }
        } catch {
    ...
    internal func _getOperation() throws -> PushOperation {
        if let document = Bartleby.sharedInstance.getDocumentByUID(self.documentUID) {
            ...
            throw BartlebyOperationError.operationNotFound(UID: "UpdateUser: \(UID)")
        }
        throw BartlebyOperationError.documentNotFound(documentUID: "UpdateUser: \(documentUID)")
    }
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
            ...
            do {
                ...
                request(r).responseJSON(completionHandler: { response in
                    ...
                    let context = HTTPContext(code: 564_249_844,
                                              caller: "UpdateUser.execute",
