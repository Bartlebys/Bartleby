    ...
    */
        ...
        failureHandler failure:@escaping (_ context:HTTPContext)->()){
            do{
                ...
                if  pushOperation.canBePushed(){
                    ...
                    self.referentDocument?.log("UpdateUser can't be pushed \(pushOperation.status)", file: #file, function: #function, line: #line, category: Default.LOG_FAULT, decorative: false)
                }
            }catch{
    ...
    internal func _getOperation()throws->PushOperation{
        if let document = Bartleby.sharedInstance.getDocumentByUID(self.documentUID) {
            ...
            throw BartlebyOperationError.operationNotFound(UID:"UpdateUser: \(self.UID)")
        }
        throw BartlebyOperationError.documentNotFound(documentUID:"UpdateUser: \(self.documentUID)")
    }
    ...
    open class func execute(_ user:User,
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
                ...
                do {
                    ...
                    let context = HTTPContext( code: 564249844,
                        caller: "UpdateUser.execute",
