...
@objc(CreateBox) public class CreateBox : BartlebyObject,BartlebyOperation{
    ...
    */
    static func commit(_ box:Box, inDocumentWithUID documentUID:String){
        let operationInstance=CreateBox(box,inDocumentWithUID:documentUID)
        operationInstance.commit()
    }


    func commit(){
        let context=Context(code:2662850060, caller: "CreateBox.commit")
        if let document = Bartleby.sharedInstance.getDocumentByUID(self._documentUID) {
            ...
            do{
				...
				pushOperation.summary="CreateBox(\(self._box.UID))"
               ...
               document.dispatchAdaptiveMessage(context,
                    ...
                    body: "Operation collection is missing in  CreateBox",
    ...
    static open func execute(_ box:Box,
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
                ...
                do {
                    ...
                    let context = HTTPContext( code: 1583538256,
