...
@objc(CreateGroups) public class CreateGroups : JObject,JHTTPCommand{
    ...
    */
    static func commit(groups:[Group], inRegistry registryUID:String){
        let operationInstance=CreateGroups(groups,inRegistry:registryUID)
    ...
    static public func execute(groups:[Group],
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(registryUID) {
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inRegistry:document.UID,withActionName:"CreateGroups" ,forMethod:"POST", and: pathURL)
