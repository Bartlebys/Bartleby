...
@objc(CreateGroups) public class CreateGroups : JObject,JHTTPCommand{
    ...
    */
    static func commit(groups:[Group], inRegistryWithUID registryUID:String){
        let operationInstance=CreateGroups(groups,inRegistryWithUID:registryUID)
    ...
    func commit(){
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(self._registryUID) {
                ...
                self._operation.summary="CreateGroups(\(stringIDS))"
                ...
                do{
                    ...
                    body: "Operation collection is missing in CreateGroups",
            ...
            Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
                    ...
                    body: "\(m) registryUID =\(self._registryUID) in CreateGroups",
                    onSelectedIndex: { (selectedIndex) -> () in
                    }
            )
        }
            ...
            if  self._operation.status==Operation.Status.Pending ||
                ...
                CreateGroups.execute(self._groups,
                    ...
                    sucessHandler: { (context: JHTTPResponse) -> () in
                        document.markAsDistributed(&self._groups)
    ...
    static public func execute(groups:[Group],
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(registryUID) {
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inRegistryWithUID:document.UID,withActionName:"CreateGroups" ,forMethod:"POST", and: pathURL)
