...
@objc(UpdateBlock) public class UpdateBlock : BartlebyObject,BartlebyOperation{
    ...
    */
    static func commit(_ block:Block, inDocumentWithUID documentUID:String){
        let operationInstance=UpdateBlock(block,inDocumentWithUID:documentUID)
        operationInstance.commit()
    }


    func commit(){
        let context=Context(code:2874210455, caller: "UpdateBlock.commit")
        if let document = Bartleby.sharedInstance.getDocumentByUID(self._documentUID) {
            ...
            do{
				...
				pushOperation.summary="UpdateBlock(\(self._block.UID))"
               ...
               document.dispatchAdaptiveMessage(context,
                    ...
                    body: "Operation collection is missing in  UpdateBlock",
    ...
    open func push(sucessHandler success:@escaping (_ context:HTTPContext)->(),
        ...
        if  pushOperation.canBePushed(){
            ...
            UpdateBlock.execute(self._block,
