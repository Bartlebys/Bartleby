...
@objc(UpdateLocker) public class UpdateLocker : BartlebyObject,BartlebyOperation{
    ...
    override open var exposedKeys:[String] {
        ...
        exposed.append(contentsOf:["_locker","_documentUID"])
        return exposed
    }
    ...
    override open func encode(with coder: NSCoder) {
		...
		if let _locker = self._locker {
			coder.encode(_locker,forKey:"_locker")
		}
    ...
    */
    static func commit(_ locker:Locker, inDocumentWithUID documentUID:String){
    ...
    func commit(){
        if let locker = self._locker{
            let context=Context(code:1710194365, caller: "\(self.runTimeTypeName()).commit")
            if let document = Bartleby.sharedInstance.getDocumentByUID(self._documentUID) {
            ...
            glog("_locker should not be nil", file: #file, function: #function, line: #line, category: Default.LOG_CATEGORY, decorative: false)
        }
    }
    ...
    open class func execute(_ locker:Locker,
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
                ...
                do {
                    ...
                    let context = HTTPContext( code: 3808377834,
