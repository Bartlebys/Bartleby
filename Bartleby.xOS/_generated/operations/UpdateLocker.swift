...
@objc public class UpdateLocker : ManagedModel,BartlebyOperation{
    ...
    */
    static func commit(_ locker:Locker, in document:BartlebyDocument){
        ...
        let context=Context(code:1710194365, caller: "\(operationInstance.runTimeTypeName()).commit")
        do{
        ...
        failureHandler failure:@escaping (_ context:HTTPContext)->()){
            do{
                ...
                if  pushOperation.canBePushed(){
                    ...
                    self.referentDocument?.log("UpdateLocker can't be pushed \(pushOperation.status)", file: #file, function: #function, line: #line, category: Default.LOG_FAULT, decorative: false)
                }
            }catch{
    ...
    internal func _getOperation()throws->PushOperation{
        if let document = Bartleby.sharedInstance.getDocumentByUID(self.documentUID) {
            ...
            throw BartlebyOperationError.operationNotFound(UID:"UpdateLocker: \(self.UID)")
        }
        throw BartlebyOperationError.documentNotFound(documentUID:"UpdateLocker: \(self.documentUID)")
    }
