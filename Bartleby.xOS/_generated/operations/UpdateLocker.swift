...
@objc(UpdateLocker) public class UpdateLocker : BartlebyObject,BartlebyOperation{
    ...
    */
    static func commit(_ locker:Locker, in document:BartlebyDocument){
        ...
        operationInstance._payload=locker.toJSONString() ?? Default.VOID_STRING
    ...
    open func push(sucessHandler success:@escaping (_ context:HTTPContext)->(),
        ...
        if let locker = Mapper <Locker>().map(JSONString:self._payload){
            do{
                ...
                if  pushOperation.canBePushed(){
                    ...
                    type(of: self).execute(locker,
						...
						Bartleby.markPushed(locker.UID)
            ...
            glog("locker should not be nil", file: #file, function: #function, line: #line, category: Default.LOG_DEVELOPER_CATEGORY, decorative: false)
        }
    }
