...
@objc(DeleteBox) public class DeleteBox : ManagedModel,BartlebyOperation{
    ...
    */
    ...
    open func push(sucessHandler success:@escaping (_ context:HTTPContext)->(),
        ...
        if let box = Mapper <Box>().map(JSONString:self._payload){
            ...
            glog("box should not be nil", file: #file, function: #function, line: #line, category: Default.LOG_WARNING, decorative: false)
        }
    }
