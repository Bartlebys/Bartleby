...
@objc public class DeleteBox: ManagedModel, BartlebyOperation {
    ...
    static func commit(_ box: Box, from document: BartlebyDocument) {
        ...
        let context = Context(code: 3_535_938_554, caller: "\(operationInstance.runTimeTypeName()).commit")
        do {
            ...
            pushOperation.operationName = DeleteBox.typeName()
    ...
    open func push(sucessHandler success: @escaping (_ context: HTTPContext) -> Void,
        ...
        do {
            ...
            if pushOperation.canBePushed() {
                ...
                referentDocument?.log("DeleteBox can't be pushed \(pushOperation.status)", file: #file, function: #function, line: #line, category: Default.LOG_FAULT, decorative: false)
            }
        } catch {
            let context = HTTPContext(code: 3,
                                      caller: "DeleteBox.execute",
                                      relatedURL: nil,
    ...
    internal func _getOperation() throws -> PushOperation {
        if let document = Bartleby.sharedInstance.getDocumentByUID(self.documentUID) {
            ...
            throw BartlebyOperationError.operationNotFound(UID: "DeleteBox: \(UID)")
        }
        throw BartlebyOperationError.documentNotFound(documentUID: "DeleteBox: \(documentUID)")
    }
    ...
    open class func execute(_ box: Box,
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
            ...
            parameters["boxId"] = box.UID
            let urlRequest = HTTPManager.requestWithToken(inDocumentWithUID: document.UID, withActionName: "DeleteBox", forMethod: "DELETE", and: pathURL)
            do {
                ...
                request(r).responseJSON(completionHandler: { response in
                    ...
                    let context = HTTPContext(code: 183_550_596,
                                              caller: "DeleteBox.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("deleteByIds  of box",
                                                  comment: "deleteByIds of box failure description")
                            ...
                            if let dictionary = result.value as? Dictionary<String, AnyObject> {
                                if let index = dictionary["triggerIndex"] as? NSNumber,
                                    ...
                                    if index.intValue >= 0 {
                                        ...
                                        acknowledgment.operationName = "DeleteBox"
