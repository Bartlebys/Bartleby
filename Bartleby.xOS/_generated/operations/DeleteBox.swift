...
@objc(DeleteBox) public class DeleteBox : BartlebyObject,BartlebyOperation{
    ...
    required public convenience init(){
        self.init(Box(), from:Default.NO_UID)
    }
    ...
    */
    init (_ box:Box=Box(), from documentUID:String) {
        self._box=box
    ...
    - parameter documentUID:     the document UID
    */
    static func commit(_ box:Box, from documentUID:String){
        let operationInstance=DeleteBox(box,from:documentUID)
        operationInstance.commit()
    }


    func commit(){
        let context=Context(code:3535938554, caller: "DeleteBox.commit")
        if let document = Bartleby.sharedInstance.getDocumentByUID(self._documentUID) {
            ...
            do{
				...
				pushOperation.summary="DeleteBox(\(self._box.UID))"
               ...
               document.dispatchAdaptiveMessage(context,
                    ...
                    body: "Operation collection is missing in  DeleteBox",
    ...
    static open func execute(_ box:Box,
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
                ...
                do {
                    ...
                    let context = HTTPContext( code: 183550596,
