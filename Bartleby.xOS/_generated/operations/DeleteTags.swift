...
@objc(DeleteTags) public class DeleteTags : ManagedModel,BartlebyOperation{
    ...
    */
    static func commit(_ tags:[Tag], from document:BartlebyDocument){
        ...
        operationInstance._payload=tags.toJSONString() ?? Default.VOID_STRING
    ...
    open func push(sucessHandler success:@escaping (_ context:HTTPContext)->(),
        ...
        if let tags = Mapper <Tag>().mapArray(JSONString:self._payload){
            do{
            ...
            glog("tags should not be nil", file: #file, function: #function, line: #line, category: Default.LOG_WARNING, decorative: false)
        }
    }
