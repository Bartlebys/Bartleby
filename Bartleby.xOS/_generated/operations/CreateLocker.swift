...
@objc public class CreateLocker: ManagedModel, BartlebyOperation {
    ...
    static func commit(_ locker: Locker, in document: BartlebyDocument) {
        ...
        let context = Context(code: 1_761_865_316, caller: "\(operationInstance.runTimeTypeName()).commit")
        do {
    ...
    open func push(sucessHandler success: @escaping (_ context: HTTPContext) -> Void,
        ...
        do {
            ...
            if pushOperation.canBePushed() {
                ...
                referentDocument?.log("CreateLocker can't be pushed \(pushOperation.status)", file: #file, function: #function, line: #line, category: Default.LOG_FAULT, decorative: false)
            }
        } catch {
    ...
    internal func _getOperation() throws -> PushOperation {
        if let document = Bartleby.sharedInstance.getDocumentByUID(self.documentUID) {
            ...
            throw BartlebyOperationError.operationNotFound(UID: "CreateLocker: \(UID)")
        }
        throw BartlebyOperationError.documentNotFound(documentUID: "CreateLocker: \(documentUID)")
    }
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
            ...
            do {
                ...
                request(r).responseJSON(completionHandler: { response in
                    ...
                    let context = HTTPContext(code: 503_102_730,
                                              caller: "CreateLocker.execute",
