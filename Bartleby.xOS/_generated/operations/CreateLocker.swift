...
@objc(CreateLocker) public class CreateLocker : JObject,JHTTPCommand{
    ...
    */
    static func commit(locker:Locker, inRegistry registryUID:String){
        let operationInstance=CreateLocker(locker,inRegistry:registryUID)
    ...
    static public func execute(locker:Locker,
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(registryUID) {
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inRegistry:document.UID,withActionName:"CreateLocker" ,forMethod:"POST", and: pathURL)
