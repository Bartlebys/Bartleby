...
@objc(DeleteAssociations) public class DeleteAssociations : ManagedModel,BartlebyOperation{
    ...
    */
    static func commit(_ associations:[Association], from document:BartlebyDocument){
        let operationInstance=DeleteAssociations()
        operationInstance.referentDocument = document
        operationInstance._payload=associations.toJSONString() ?? Default.VOID_STRING
        let context=Context(code:3366028774, caller: "\(operationInstance.runTimeTypeName()).commit")
        do{
    ...
    open func push(sucessHandler success:@escaping (_ context:HTTPContext)->(),
        ...
        if let associations = Mapper <Association>().mapArray(JSONString:self._payload){
            do{
                ...
                caller: "DeleteAssociations.execute",
                relatedURL:nil,
    ...
    open class func execute(_ associations:[Association],
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
                ...
                parameters["ids"]=associations.map{$0.UID}
                let urlRequest=HTTPManager.requestWithToken(inDocumentWithUID:document.UID,withActionName:"DeleteAssociations" ,forMethod:"DELETE", and: pathURL)
                do {
                    ...
                    let context = HTTPContext( code: 518782317,
                        caller: "DeleteAssociations.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("deleteByIds  of associations",
                            comment: "deleteByIds of associations failure description")
                            ...
                            if let dictionary = result.value as? Dictionary< String,AnyObject > {
                                if let index=dictionary["triggerIndex"] as? NSNumber,
                                    let triggerRelayDuration=dictionary["triggerRelayDuration"] as? NSNumber{
										...
										acknowledgment.operationName="DeleteAssociations"
