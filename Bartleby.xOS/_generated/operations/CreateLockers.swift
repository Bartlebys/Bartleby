...
@objc(CreateLockers) open class CreateLockers : JObject,JHTTPCommand{
    ...
    required public init?(coder decoder: NSCoder) {
        ...
        self.disableSupervisionAndCommit()
		self._lockers=decoder.decodeObject(of: NSSet(array: [NSArray.classForCoder(),Locker.classForCoder()]), forKey: "_lockers")! as! [Locker]
    ...
    */
    ...
    func commit(){
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(self._registryUID) {
            ...
            Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
                    ...
                    body: "\(m) registryUID =\(self._registryUID) in CreateLockers",
                    onSelectedIndex: { (selectedIndex) -> () in
                    }
            )
        }
    ...
    static open func execute(_ lockers:[Locker],
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(registryUID) {
                ...
                parameters["lockers"]=collection as AnyObject?
