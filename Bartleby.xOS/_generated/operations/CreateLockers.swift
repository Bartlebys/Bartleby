...
@objc public class CreateLockers: ManagedModel, BartlebyOperation {
    ...
    static func commit(_ lockers: [Locker], in document: BartlebyDocument) {
        ...
        let context = Context(code: 3_510_917_490, caller: "\(operationInstance.runTimeTypeName()).commit")
        do {
    ...
    open func push(sucessHandler success: @escaping (_ context: HTTPContext) -> Void,
        ...
        do {
            ...
            if pushOperation.canBePushed() {
                ...
                referentDocument?.log("CreateLockers can't be pushed \(pushOperation.status)", file: #file, function: #function, line: #line, category: Default.LOG_FAULT, decorative: false)
            }
        } catch {
    ...
    internal func _getOperation() throws -> PushOperation {
        if let document = Bartleby.sharedInstance.getDocumentByUID(self.documentUID) {
            ...
            throw BartlebyOperationError.operationNotFound(UID: "CreateLockers: \(UID)")
        }
        throw BartlebyOperationError.documentNotFound(documentUID: "CreateLockers: \(documentUID)")
    }
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
            ...
            do {
                ...
                request(r).responseJSON(completionHandler: { response in
                    ...
                    let context = HTTPContext(code: 3_918_548_972,
                                              caller: "CreateLockers.execute",
