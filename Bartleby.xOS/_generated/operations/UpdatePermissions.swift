...
@objc(UpdatePermissions) public class UpdatePermissions : JObject,JHTTPCommand{
    ...
    */
    static func commit(permissions:[Permission], inRegistry registryUID:String){
        let operationInstance=UpdatePermissions(permissions,inRegistry:registryUID)
    ...
    static public func execute(permissions:[Permission],
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(registryUID) {
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inRegistry:document.UID,withActionName:"UpdatePermissions" ,forMethod:"PUT", and: pathURL)
