...
@objc(UpdatePermissions) public class UpdatePermissions : JObject,JHTTPCommand{
    ...
    */
    static func commit(permissions:[Permission], inRegistryWithUID registryUID:String){
        let operationInstance=UpdatePermissions(permissions,inRegistryWithUID:registryUID)
    ...
    func commit(){
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(self._registryUID) {
                ...
                do{
                    ...
                    body: "Operation collection is missing in UpdatePermissions",
            ...
            Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
                    ...
                    body: "\(m) registryUID =\(self._registryUID) in UpdatePermissions",
                    onSelectedIndex: { (selectedIndex) -> () in
                    }
            )
        }
    ...
    static public func execute(permissions:[Permission],
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(registryUID) {
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inRegistryWithUID:document.UID,withActionName:"UpdatePermissions" ,forMethod:"PUT", and: pathURL)
