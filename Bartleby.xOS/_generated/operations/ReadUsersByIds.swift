...
@objc(ReadUsersByIds) open class ReadUsersByIds : ManagedModel{
    ...
    public static func execute(from documentUID:String,
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
            ...
            let urlRequest=HTTPManager.requestWithToken(inDocumentWithUID:document.UID,withActionName:"ReadUsersByIds" ,forMethod:"GET", and: pathURL)
            ...
            do {
                ...
                request(r).responseData(completionHandler: { (response) in
                    ...
                    let context = HTTPContext( code: 745776284,
                          ...
                          if 200...299 ~= statusCode {
	                        do{
	                            if let data = response.data{
	                                let instance = try JSONDecoder().decode([User].self,from:data)
	                                success(instance)
	                              }else{
