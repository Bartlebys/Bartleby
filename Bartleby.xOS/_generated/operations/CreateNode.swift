...
@objc(CreateNode) public class CreateNode : ManagedModel,BartlebyOperation{
    ...
    */
    ...
    open func push(sucessHandler success:@escaping (_ context:HTTPContext)->(),
        ...
        if let node = Mapper <Node>().map(JSONString:self._payload){
            do{
            ...
            glog("node should not be nil", file: #file, function: #function, line: #line, category: Default.LOG_WARNING, decorative: false)
        }
    }
