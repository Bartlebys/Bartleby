...
@objc public class CreateUser: ManagedModel, BartlebyOperation {
    ...
    static func commit(_ user: User, in document: BartlebyDocument) {
        ...
        let context = Context(code: 3_114_275_262, caller: "\(operationInstance.runTimeTypeName()).commit")
        do {
    ...
    open func push(sucessHandler success: @escaping (_ context: HTTPContext) -> Void,
        ...
        do {
            let user = try JSON.decoder.decode(User.self, from: _payload ?? Data())
            ...
            if pushOperation.canBePushed() {
                ...
                referentDocument?.log("CreateUser can't be pushed \(pushOperation.status)", file: #file, function: #function, line: #line, category: Default.LOG_FAULT, decorative: false)
            }
        } catch {
    ...
    internal func _getOperation() throws -> PushOperation {
        if let document = Bartleby.sharedInstance.getDocumentByUID(self.documentUID) {
            ...
            throw BartlebyOperationError.operationNotFound(UID: "CreateUser: \(UID)")
        }
        throw BartlebyOperationError.documentNotFound(documentUID: "CreateUser: \(documentUID)")
    }
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
            ...
            do {
                ...
                request(r).responseJSON(completionHandler: { response in
                    ...
                    let context = HTTPContext(code: 2_066_359_615,
                                              caller: "CreateUser.execute",
