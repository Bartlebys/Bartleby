...
@objc(CreateUser) open class CreateUser : JObject,JHTTPCommand{
    ...
    */
    ...
    static open func execute(_ user:User,
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(registryUID) {
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inRegistryWithUID:document.UID,withActionName:"CreateUser" ,forMethod:"POST", and: pathURL)
