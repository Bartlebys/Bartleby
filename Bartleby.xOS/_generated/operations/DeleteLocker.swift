...
@objc public class DeleteLocker: ManagedModel, BartlebyOperation {
     ...
     */
    static func commit(_ locker: Locker, from document: BartlebyDocument) {
        ...
        let context = Context(code: 1_496_840_969, caller: "\(operationInstance.runTimeTypeName()).commit")
        do {
            ...
            pushOperation.operationName = DeleteLocker.typeName()
    ...
    open func push(sucessHandler success: @escaping (_ context: HTTPContext) -> Void,
        ...
        do {
            ...
            if pushOperation.canBePushed() {
                ...
                referentDocument?.log("DeleteLocker can't be pushed \(pushOperation.status)", file: #file, function: #function, line: #line, category: Default.LOG_FAULT, decorative: false)
            }
        } catch {
    ...
    internal func _getOperation() throws -> PushOperation {
        if let document = Bartleby.sharedInstance.getDocumentByUID(self.documentUID) {
            ...
            throw BartlebyOperationError.operationNotFound(UID: "DeleteLocker: \(UID)")
        }
        throw BartlebyOperationError.documentNotFound(documentUID: "DeleteLocker: \(documentUID)")
    }
    ...
    open class func execute(_ locker: Locker,
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
            ...
            let urlRequest = HTTPManager.requestWithToken(inDocumentWithUID: document.UID, withActionName: "DeleteLocker", forMethod: "DELETE", and: pathURL)
            do {
                ...
                request(r).responseJSON(completionHandler: { response in
                    ...
                    let context = HTTPContext(code: 785_356_026,
                                              caller: "DeleteLocker.execute",
                            ...
                            if let dictionary = result.value as? Dictionary<String, AnyObject> {
                                if let index = dictionary["triggerIndex"] as? NSNumber,
                                    ...
                                    if index.intValue >= 0 {
                                        ...
                                        acknowledgment.operationName = "DeleteLocker"
