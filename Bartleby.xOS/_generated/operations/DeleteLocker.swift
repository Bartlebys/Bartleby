...
@objc public class DeleteLocker : ManagedModel,BartlebyOperation{
    ...
    */
    static func commit(_ locker:Locker, from document:BartlebyDocument){
        ...
        let context=Context(code:1496840969, caller: "\(operationInstance.runTimeTypeName()).commit")
        do{
        ...
        failureHandler failure:@escaping (_ context:HTTPContext)->()){
            do{
                ...
                if  pushOperation.canBePushed(){
                    ...
                    self.referentDocument?.log("DeleteLocker can't be pushed \(pushOperation.status)", file: #file, function: #function, line: #line, category: Default.LOG_FAULT, decorative: false)
                }
            }catch{
    ...
    internal func _getOperation()throws->PushOperation{
        if let document = Bartleby.sharedInstance.getDocumentByUID(self.documentUID) {
            ...
            throw BartlebyOperationError.operationNotFound(UID:"DeleteLocker: \(self.UID)")
        }
        throw BartlebyOperationError.documentNotFound(documentUID:"DeleteLocker: \(self.documentUID)")
    }
    ...
    open class func execute(_ locker:Locker,
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
                ...
                do {
                    ...
                    let context = HTTPContext( code: 785356026,
                        caller: "DeleteLocker.execute",
