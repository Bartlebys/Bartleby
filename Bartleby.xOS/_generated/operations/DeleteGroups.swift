...
@objc(DeleteGroups) public class DeleteGroups : JObject,JHTTPCommand{
    ...
    */
    static func commit(ids:[String], fromRegistryWithUID registryUID:String){
        let operationInstance=DeleteGroups(ids,fromRegistryWithUID:registryUID)
    ...
    static public func execute(ids:[String],
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(registryUID) {
                ...
                parameters["ids"]=ids
                let urlRequest=HTTPManager.mutableRequestWithToken(inRegistryWithUID:document.UID,withActionName:"DeleteGroups" ,forMethod:"DELETE", and: pathURL)
