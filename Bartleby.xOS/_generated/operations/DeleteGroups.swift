...
@objc(DeleteGroups) public class DeleteGroups : JObject,JHTTPCommand{
    ...
    */
    init (_ ids:[String]=[String](), fromRegistry registryUID:String) {
        self._ids=ids
    ...
    - parameter registryUID:     the registry or document UID
    */
    static func commit(ids:[String], fromRegistry registryUID:String){
        let operationInstance=DeleteGroups(ids,fromRegistry:registryUID)
    ...
    func commit(){
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(self._registryUID) {
            ...
            Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
                    ...
                    body: "\(m) registryUID =\(self._registryUID) in DeleteGroups",
                    onSelectedIndex: { (selectedIndex) -> () in
                    }
            )
        }
    ...
    static public func execute(ids:[String],
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(registryUID) {
                ...
                parameters["ids"]=ids
                let urlRequest=HTTPManager.mutableRequestWithToken(inRegistry:document.UID,withActionName:"DeleteGroups" ,forMethod:"DELETE", and: pathURL)
