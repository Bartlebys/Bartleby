...
@objc(CreateGroup) public class CreateGroup : JObject,JHTTPCommand{
    ...
    */
    static func commit(group:Group, inRegistry registryUID:String){
        let operationInstance=CreateGroup(group,inRegistry:registryUID)
    ...
    static public func execute(group:Group,
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(registryUID) {
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inRegistry:document.UID,withActionName:"CreateGroup" ,forMethod:"POST", and: pathURL)
