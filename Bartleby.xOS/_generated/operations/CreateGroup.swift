...
@objc(CreateGroup) public class CreateGroup : JObject,JHTTPCommand{
    ...
    */
    static func commit(group:Group, inRegistryWithUID registryUID:String){
        let operationInstance=CreateGroup(group,inRegistryWithUID:registryUID)
    ...
    func commit(){
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(self._registryUID) {
                ...
                self._operation.summary="CreateGroup(\(self._group.UID))"
                ...
                do{
                    ...
                    body: "Operation collection is missing in CreateGroup",
            ...
            Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
                    ...
                    body: "\(m) registryUID =\(self._registryUID) in CreateGroup",
                    onSelectedIndex: { (selectedIndex) -> () in
                    }
            )
        }
            ...
            if  self._operation.status==Operation.Status.Pending ||
                ...
                CreateGroup.execute(self._group,
                    ...
                    sucessHandler: { (context: JHTTPResponse) -> () in
                        document.markAsDistributed(&self._group)
    ...
    static public func execute(group:Group,
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(registryUID) {
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inRegistryWithUID:document.UID,withActionName:"CreateGroup" ,forMethod:"POST", and: pathURL)
