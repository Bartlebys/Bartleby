...
@objc public class DeleteLocalizedDatum: ManagedModel, BartlebyOperation {
    ...
    static func commit(_ localizedDatum: LocalizedDatum, from document: BartlebyDocument) {
        ...
        let context = Context(code: 2_241_463_531, caller: "\(operationInstance.runTimeTypeName()).commit")
        do {
    ...
    open func push(sucessHandler success: @escaping (_ context: HTTPContext) -> Void,
        ...
        do {
            ...
            if pushOperation.canBePushed() {
                ...
                referentDocument?.log("DeleteLocalizedDatum can't be pushed \(pushOperation.status)", file: #file, function: #function, line: #line, category: Default.LOG_FAULT, decorative: false)
            }
        } catch {
    ...
    internal func _getOperation() throws -> PushOperation {
        if let document = Bartleby.sharedInstance.getDocumentByUID(self.documentUID) {
            ...
            throw BartlebyOperationError.operationNotFound(UID: "DeleteLocalizedDatum: \(UID)")
        }
        throw BartlebyOperationError.documentNotFound(documentUID: "DeleteLocalizedDatum: \(documentUID)")
    }
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
            ...
            do {
                ...
                request(r).responseJSON(completionHandler: { response in
                    ...
                    let context = HTTPContext(code: 1_612_167_761,
                                              caller: "DeleteLocalizedDatum.execute",
