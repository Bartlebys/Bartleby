...
@objc(CreateBoxes) public class CreateBoxes : BartlebyObject,BartlebyOperation{
    ...
    fileprivate var _boxes:[Box] = [Box]()
    ...
    override open func encode(with coder: NSCoder) {
		...
		coder.encode(self._boxes,forKey:"_boxes")
    ...
    - parameter boxes: the [Box] concerned the operation
    - parameter documentUID the document UID

    */
    init (_ boxes:[Box]=[Box](), inDocumentWithUID documentUID:String) {
        self._boxes=boxes
    ...
    */
    static func commit(_ boxes:[Box], inDocumentWithUID documentUID:String){
        let operationInstance=CreateBoxes(boxes,inDocumentWithUID:documentUID)
        operationInstance.commit()
    }


    func commit(){
        let context=Context(code:1896855256, caller: "CreateBoxes.commit")
        if let document = Bartleby.sharedInstance.getDocumentByUID(self._documentUID) {
            ...
            do{
				...
				let stringIDS=PString.ltrim(self._boxes.reduce("", { $0+","+$1.UID }),characters:",")
				pushOperation.summary="CreateBoxes(\(stringIDS))"
               ...
               document.dispatchAdaptiveMessage(context,
                    ...
                    body: "Operation collection is missing in  CreateBoxes",
    ...
    open func push(sucessHandler success:@escaping (_ context:HTTPContext)->(),
        ...
        if  pushOperation.canBePushed(){
            ...
            CreateBoxes.execute(self._boxes,
    ...
    static open func execute(_ boxes:[Box],
