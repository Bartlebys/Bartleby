...
@objc public class DeleteLocalizedData : ManagedModel,BartlebyOperation{

    // Universal type support
    override open class func typeName() -> String {
        return "DeleteLocalizedData"
    }
    ...
    */
    static func commit(_ localizedData:[LocalizedDatum], from document:BartlebyDocument){
        ...
        let operationInstance = DeleteLocalizedData()
        operationInstance.UID = Bartleby.createUID()
        operationInstance.referentDocument = document
        let context=Context(code:2786690768, caller: "\(operationInstance.runTimeTypeName()).commit")
        do{
            ...
            pushOperation.operationName = DeleteLocalizedData.typeName()
        ...
        failureHandler failure:@escaping (_ context:HTTPContext)->()){
            do{
                ...
                if  pushOperation.canBePushed(){
                    ...
                    self.referentDocument?.log("DeleteLocalizedData can't be pushed \(pushOperation.status)", file: #file, function: #function, line: #line, category: Default.LOG_FAULT, decorative: false)
                }
            }catch{
                let context = HTTPContext( code:3 ,
                caller: "DeleteLocalizedData.execute",
                relatedURL:nil,
    ...
    internal func _getOperation()throws->PushOperation{
        if let document = Bartleby.sharedInstance.getDocumentByUID(self.documentUID) {
            ...
            throw BartlebyOperationError.operationNotFound(UID:"DeleteLocalizedData: \(self.UID)")
        }
        throw BartlebyOperationError.documentNotFound(documentUID:"DeleteLocalizedData: \(self.documentUID)")
    }
    ...
    open class func execute(_ localizedData:[LocalizedDatum],
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
                ...
                parameters["ids"] = localizedData.map{$0.UID}
                let urlRequest=HTTPManager.requestWithToken(inDocumentWithUID:document.UID,withActionName:"DeleteLocalizedData" ,forMethod:"DELETE", and: pathURL)
                do {
                    ...
                    let context = HTTPContext( code: 3510620407,
                        caller: "DeleteLocalizedData.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("deleteByIds  of localizedData",
                            comment: "deleteByIds of localizedData failure description")
                                ...
                                if let index=dictionary["triggerIndex"] as? NSNumber,
                                    let triggerRelayDuration=dictionary["triggerRelayDuration"] as? NSNumber{
										if index.intValue >= 0 {
										    ...
										    acknowledgment.operationName="DeleteLocalizedData"
