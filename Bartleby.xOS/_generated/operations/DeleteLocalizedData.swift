...
@objc public class DeleteLocalizedData: ManagedModel, BartlebyOperation {
    ...
    static func commit(_ localizedData: [LocalizedDatum], from document: BartlebyDocument) {
        ...
        let context = Context(code: 2_786_690_768, caller: "\(operationInstance.runTimeTypeName()).commit")
        do {
    ...
    open func push(sucessHandler success: @escaping (_ context: HTTPContext) -> Void,
        ...
        do {
            ...
            if pushOperation.canBePushed() {
                ...
                referentDocument?.log("DeleteLocalizedData can't be pushed \(pushOperation.status)", file: #file, function: #function, line: #line, category: Default.LOG_FAULT, decorative: false)
            }
        } catch {
    ...
    internal func _getOperation() throws -> PushOperation {
        if let document = Bartleby.sharedInstance.getDocumentByUID(self.documentUID) {
            ...
            throw BartlebyOperationError.operationNotFound(UID: "DeleteLocalizedData: \(UID)")
        }
        throw BartlebyOperationError.documentNotFound(documentUID: "DeleteLocalizedData: \(documentUID)")
    }
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
            ...
            do {
                ...
                request(r).responseJSON(completionHandler: { response in
                    ...
                    let context = HTTPContext(code: 3_510_620_407,
                                              caller: "DeleteLocalizedData.execute",
