...
@objc public class UpdateBlocks: ManagedModel, BartlebyOperation {
    ...
    static func commit(_ blocks: [Block], in document: BartlebyDocument) {
        ...
        let context = Context(code: 4_113_738_178, caller: "\(operationInstance.runTimeTypeName()).commit")
        do {
            ...
            pushOperation.operationName = UpdateBlocks.typeName()
    ...
    open func push(sucessHandler success: @escaping (_ context: HTTPContext) -> Void,
        ...
        do {
            ...
            if pushOperation.canBePushed() {
                ...
                referentDocument?.log("UpdateBlocks can't be pushed \(pushOperation.status)", file: #file, function: #function, line: #line, category: Default.LOG_FAULT, decorative: false)
            }
        } catch {
    ...
    internal func _getOperation() throws -> PushOperation {
        if let document = Bartleby.sharedInstance.getDocumentByUID(self.documentUID) {
            ...
            throw BartlebyOperationError.operationNotFound(UID: "UpdateBlocks: \(UID)")
        }
        throw BartlebyOperationError.documentNotFound(documentUID: "UpdateBlocks: \(documentUID)")
    }
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
            ...
            do {
                ...
                request(r).responseJSON(completionHandler: { response in
                    ...
                    let context = HTTPContext(code: 584_419_984,
                                              caller: "UpdateBlocks.execute",
