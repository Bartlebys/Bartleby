...
@objc(UpdateLockers) public class UpdateLockers : JObject,JHTTPCommand{
    ...
    */
    static func commit(lockers:[Locker], inRegistry registryUID:String){
        let operationInstance=UpdateLockers(lockers,inRegistry:registryUID)
    ...
    static public func execute(lockers:[Locker],
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(registryUID) {
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inRegistry:document.UID,withActionName:"UpdateLockers" ,forMethod:"PUT", and: pathURL)
