...
@objc(CreatePermission) public class CreatePermission : JObject,JHTTPCommand{
    ...
    */
    static func commit(permission:Permission, inRegistryWithUID registryUID:String){
        let operationInstance=CreatePermission(permission,inRegistryWithUID:registryUID)
    ...
    func commit(){
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(self._registryUID) {
            ...
            do{
                ...
                operation.summary="CreatePermission(\(self._permission.UID))"
                ...
                Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
                    ...
                    body: "Operation collection is missing in  CreatePermission",
            ...
            Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
                    ...
                    body: "\(m) registryUID =\(self._registryUID) in CreatePermission",
                    onSelectedIndex: { (selectedIndex) -> () in
                    }
            )
        }
        ...
        if  operation.canBePushed(){
            ...
            CreatePermission.execute(self._permission,
                ...
                sucessHandler: { (context: JHTTPResponse) -> () in
                    self._permission.distributed=true
    ...
    static public func execute(permission:Permission,
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(registryUID) {
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inRegistryWithUID:document.UID,withActionName:"CreatePermission" ,forMethod:"POST", and: pathURL)
