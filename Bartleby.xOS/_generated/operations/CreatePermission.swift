...
@objc(CreatePermission) public class CreatePermission : JObject,JHTTPCommand{
    ...
    */
    static func commit(permission:Permission, inRegistry registryUID:String){
        let operationInstance=CreatePermission(permission,inRegistry:registryUID)
    ...
    static public func execute(permission:Permission,
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(registryUID) {
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inRegistry:document.UID,withActionName:"CreatePermission" ,forMethod:"POST", and: pathURL)
