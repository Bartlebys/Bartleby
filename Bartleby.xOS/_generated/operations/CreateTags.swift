...
@objc public class CreateTags : ManagedModel,BartlebyOperation{
    ...
    */
        ...
        failureHandler failure:@escaping (_ context:HTTPContext)->()){
            do{
                ...
                if  pushOperation.canBePushed(){
                    ...
                    self.referentDocument?.log("CreateTags can't be pushed \(pushOperation.status)", file: #file, function: #function, line: #line, category: Default.LOG_FAULT, decorative: false)
                }
            }catch{
                let context = HTTPContext( code:3 ,
                caller: "CreateTags.execute",
                relatedURL:nil,
    ...
    internal func _getOperation()throws->PushOperation{
        if let document = Bartleby.sharedInstance.getDocumentByUID(self.documentUID) {
            ...
            throw BartlebyOperationError.operationNotFound(UID:"CreateTags: \(self.UID)")
        }
        throw BartlebyOperationError.documentNotFound(documentUID:"CreateTags: \(self.documentUID)")
    }
    ...
    open class func execute(_ tags:[Tag],
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
                ...
                let urlRequest=HTTPManager.requestWithToken(inDocumentWithUID:document.UID,withActionName:"CreateTags" ,forMethod:"POST", and: pathURL)
                do {
                    ...
                    let context = HTTPContext( code: 94097444,
                        caller: "CreateTags.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("creation  of tags",
                            comment: "creation of tags failure description")
                                ...
                                if let index=dictionary["triggerIndex"] as? NSNumber,
                                    let triggerRelayDuration=dictionary["triggerRelayDuration"] as? NSNumber{
										if index.intValue >= 0 {
										    ...
										    acknowledgment.operationName="CreateTags"
