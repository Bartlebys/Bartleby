...
@objc(CreateBlock) public class CreateBlock : BartlebyObject,BartlebyOperation{
    ...
    */
    init (_ block:Block=Block(), inDocumentWithUID documentUID:String) {
        self._block=block
    ...
    */
    static func commit(_ block:Block, inDocumentWithUID documentUID:String){
        let operationInstance=CreateBlock(block,inDocumentWithUID:documentUID)
        operationInstance.commit()
    }


    func commit(){
        let context=Context(code:4057667932, caller: "CreateBlock.commit")
        if let document = Bartleby.sharedInstance.getDocumentByUID(self._documentUID) {
            ...
            do{
				...
				pushOperation.summary="CreateBlock(\(self._block.UID))"
               ...
               document.dispatchAdaptiveMessage(context,
                    ...
                    body: "Operation collection is missing in  CreateBlock",
    ...
    open func push(sucessHandler success:@escaping (_ context:HTTPContext)->(),
        ...
        if  pushOperation.canBePushed(){
            ...
            CreateBlock.execute(self._block,
