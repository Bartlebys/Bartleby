...
@objc public class CreateBlock : ManagedModel,BartlebyOperation{
    ...
    */
    static func commit(_ block:Block, in document:BartlebyDocument){
        ...
        let context=Context(code:4057667932, caller: "\(operationInstance.runTimeTypeName()).commit")
        do{
            ...
            pushOperation.operationName = CreateBlock.typeName()
        ...
        failureHandler failure:@escaping (_ context:HTTPContext)->()){
            do{
                ...
                if  pushOperation.canBePushed(){
                    ...
                    self.referentDocument?.log("CreateBlock can't be pushed \(pushOperation.status)", file: #file, function: #function, line: #line, category: Default.LOG_FAULT, decorative: false)
                }
            }catch{
                let context = HTTPContext( code:3 ,
                caller: "CreateBlock.execute",
                relatedURL:nil,
    ...
    internal func _getOperation()throws->PushOperation{
        if let document = Bartleby.sharedInstance.getDocumentByUID(self.documentUID) {
            ...
            throw BartlebyOperationError.operationNotFound(UID:"CreateBlock: \(self.UID)")
        }
        throw BartlebyOperationError.documentNotFound(documentUID:"CreateBlock: \(self.documentUID)")
    }
    ...
    open class func execute(_ block:Block,
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
                ...
                let urlRequest=HTTPManager.requestWithToken(inDocumentWithUID:document.UID,withActionName:"CreateBlock" ,forMethod:"POST", and: pathURL)
                do {
                    ...
                    let context = HTTPContext( code: 895933795,
                        caller: "CreateBlock.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("creation  of block",
                            comment: "creation of block failure description")
                                ...
                                if let index=dictionary["triggerIndex"] as? NSNumber,
                                    let triggerRelayDuration=dictionary["triggerRelayDuration"] as? NSNumber{
										if index.intValue >= 0 {
										    ...
										    acknowledgment.operationName="CreateBlock"
