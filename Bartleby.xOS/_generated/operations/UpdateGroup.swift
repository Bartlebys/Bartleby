...
@objc(UpdateGroup) public class UpdateGroup : JObject,JHTTPCommand{
    ...
    */
    init (_ group:Group=Group(), inRegistryWithUID registryUID:String) {
        self._group=group
    ...
    - parameter registryUID:     the registry or document UID
    */
    static func commit(group:Group, inRegistryWithUID registryUID:String){
        let operationInstance=UpdateGroup(group,inRegistryWithUID:registryUID)
        operationInstance.commit()
    }


    func commit(){
        let context=Context(code:829978316, caller: "UpdateGroup.commit")
        if let document = Bartleby.sharedInstance.getDocumentByUID(self._registryUID) {
            ...
            do{
                ...
                operation.summary="UpdateGroup(\(self._group.UID))"
                ...
                Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
                    ...
                    body: "Operation collection is missing in  UpdateGroup",
            ...
            Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
                    ...
                    body: "\(m) registryUID =\(self._registryUID) in UpdateGroup",
                    onSelectedIndex: { (selectedIndex) -> () in
                    }
            )
        }
    ...
    public func push(sucessHandler success:(context:JHTTPResponse)->(),
        ...
        if  operation.canBePushed(){
            ...
            // This document is not available there is nothing to do.
            let context=Context(code:104458334, caller: "UpdateGroup.push")
            Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
    ...
    static public func execute(group:Group,
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(registryUID) {
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inRegistryWithUID:document.UID,withActionName:"UpdateGroup" ,forMethod:"PUT", and: pathURL)
                ...
                r.responseJSON{ response in
                    ...
                    let context = JHTTPResponse( code: 3316247880,
                        caller: "UpdateGroup.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("update  of group",
                            comment: "update of group failure description")
