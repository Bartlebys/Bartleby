...
import Foundation
	...
	import Alamofire
#endif
@objc(ReadTagsByIdsParameters) public class ReadTagsByIdsParameters : ManagedModel {
		// Universal type support
	override open class func typeName() -> String {
		 return "ReadTagsByIdsParameters"
	}
	// 
...
@objc(ReadTagsByIds) open class ReadTagsByIds : ManagedModel{

    // Universal type support
    override open class func typeName() -> String {
           return "ReadTagsByIds"
    }


    public static func execute(from documentUID:String,
						parameters:ReadTagsByIdsParameters,
						sucessHandler success:@escaping(_ tags:[Tag])->(),
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
            ...
            let urlRequest=HTTPManager.requestWithToken(inDocumentWithUID:document.UID,withActionName:"ReadTagsByIds" ,forMethod:"GET", and: pathURL)
            ...
            do {
                ...
                request(r).responseData(completionHandler: { (response) in
                    ...
                    let context = HTTPContext( code: 3968815964,
                        caller: "ReadTagsByIds.execute",
					...
					metrics.operationName="ReadTagsByIds"
