...
@objc(CreateTag) public class CreateTag : ManagedModel,BartlebyOperation{
    ...
    */
    ...
    open class func execute(_ tag:Tag,
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
                ...
                let urlRequest=HTTPManager.requestWithToken(inDocumentWithUID:document.UID,withActionName:"CreateTag" ,forMethod:"POST", and: pathURL)
                do {
                    ...
                    let context = HTTPContext( code: 1972458443,
                        caller: "CreateTag.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("creation  of tag",
                            comment: "creation of tag failure description")
                                ...
                                if let index=dictionary["triggerIndex"] as? NSNumber,
                                    let triggerRelayDuration=dictionary["triggerRelayDuration"] as? NSNumber{
										if index.intValue >= 0 {
										    ...
										    acknowledgment.operationName="CreateTag"
