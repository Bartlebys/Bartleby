...
@objc(DeleteUser) public class DeleteUser : JObject,JHTTPCommand{
    ...
    */
    init (_ userId:String=String(), fromRegistry registryUID:String) {
        self._userId=userId
    ...
    - parameter registryUID:     the registry or document UID
    */
    static func commit(userId:String, fromRegistry registryUID:String){
        let operationInstance=DeleteUser(userId,fromRegistry:registryUID)
    ...
    static public func execute(userId:String,
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(registryUID) {
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inRegistry:document.UID,withActionName:"DeleteUser" ,forMethod:"DELETE", and: pathURL)
