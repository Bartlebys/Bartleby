...
@objc public class DeleteBlocks: ManagedModel, BartlebyOperation {
    ...
    static func commit(_ blocks: [Block], from document: BartlebyDocument) {
        ...
        let context = Context(code: 3_387_567_222, caller: "\(operationInstance.runTimeTypeName()).commit")
        do {
    ...
    open func push(sucessHandler success: @escaping (_ context: HTTPContext) -> Void,
        ...
        do {
            ...
            if pushOperation.canBePushed() {
                ...
                referentDocument?.log("DeleteBlocks can't be pushed \(pushOperation.status)", file: #file, function: #function, line: #line, category: Default.LOG_FAULT, decorative: false)
            }
        } catch {
    ...
    internal func _getOperation() throws -> PushOperation {
        if let document = Bartleby.sharedInstance.getDocumentByUID(self.documentUID) {
            ...
            throw BartlebyOperationError.operationNotFound(UID: "DeleteBlocks: \(UID)")
        }
        throw BartlebyOperationError.documentNotFound(documentUID: "DeleteBlocks: \(documentUID)")
    }
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
            ...
            do {
                ...
                request(r).responseJSON(completionHandler: { response in
                    ...
                    let context = HTTPContext(code: 4_007_994_752,
                                              caller: "DeleteBlocks.execute",
