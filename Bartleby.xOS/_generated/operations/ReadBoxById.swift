...
@objc(ReadBoxById) open class ReadBoxById : ManagedModel{
    ...
    public static func execute(from documentUID:String,
						boxId:String,
						sucessHandler success:@escaping(_ box:Box)->(),
						failureHandler failure:@escaping(_ context:HTTPContext)->()){
	
        if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
            let pathURL=document.baseURL.appendingPathComponent("box/\(boxId)")
            let dictionary:[String:Any]=[String:Any]()
            let urlRequest=HTTPManager.requestWithToken(inDocumentWithUID:document.UID,withActionName:"ReadBoxById" ,forMethod:"GET", and: pathURL)
            ...
            do {
                ...
                request(r).responseData(completionHandler: { (response) in
                    ...
                    let context = HTTPContext( code: 2179973422,
                        caller: "ReadBoxById.execute",
					...
					metrics.operationName="ReadBoxById"
