...
@objc public class DeleteBlock: ManagedModel, BartlebyOperation {
    ...
    static func commit(_ block: Block, from document: BartlebyDocument) {
        ...
        let context = Context(code: 1_882_299_827, caller: "\(operationInstance.runTimeTypeName()).commit")
        do {
    ...
    open func push(sucessHandler success: @escaping (_ context: HTTPContext) -> Void,
        ...
        do {
            ...
            if pushOperation.canBePushed() {
                ...
                referentDocument?.log("DeleteBlock can't be pushed \(pushOperation.status)", file: #file, function: #function, line: #line, category: Default.LOG_FAULT, decorative: false)
            }
        } catch {
    ...
    internal func _getOperation() throws -> PushOperation {
        if let document = Bartleby.sharedInstance.getDocumentByUID(self.documentUID) {
            ...
            throw BartlebyOperationError.operationNotFound(UID: "DeleteBlock: \(UID)")
        }
        throw BartlebyOperationError.documentNotFound(documentUID: "DeleteBlock: \(documentUID)")
    }
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
            ...
            do {
                ...
                request(r).responseJSON(completionHandler: { response in
                    ...
                    let context = HTTPContext(code: 89_311_246,
                                              caller: "DeleteBlock.execute",
