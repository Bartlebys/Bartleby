...
@objc(UpdateTag) public class UpdateTag : ManagedModel,BartlebyOperation{
    ...
    */
    static func commit(_ tag:Tag, in document:BartlebyDocument){
        ...
        operationInstance._payload=tag.toJSONString() ?? Default.VOID_STRING
    ...
    open func push(sucessHandler success:@escaping (_ context:HTTPContext)->(),
        ...
        if let tag = Mapper <Tag>().map(JSONString:self._payload){
            do{
            ...
            glog("tag should not be nil", file: #file, function: #function, line: #line, category: Default.LOG_WARNING, decorative: false)
        }
    }
    ...
    open class func execute(_ tag:Tag,
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
                ...
                parameters["tag"]=Mapper<Tag>().toJSON(tag)
