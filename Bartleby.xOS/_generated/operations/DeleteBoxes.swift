...
@objc public class DeleteBoxes: ManagedModel, BartlebyOperation {
    ...
    static func commit(_ boxes: [Box], from document: BartlebyDocument) {
        ...
        let context = Context(code: 4_041_552_439, caller: "\(operationInstance.runTimeTypeName()).commit")
        do {
            ...
            pushOperation.operationName = DeleteBoxes.typeName()
    ...
    open func push(sucessHandler success: @escaping (_ context: HTTPContext) -> Void,
        ...
        do {
            ...
            if pushOperation.canBePushed() {
                ...
                referentDocument?.log("DeleteBoxes can't be pushed \(pushOperation.status)", file: #file, function: #function, line: #line, category: Default.LOG_FAULT, decorative: false)
            }
        } catch {
    ...
    internal func _getOperation() throws -> PushOperation {
        if let document = Bartleby.sharedInstance.getDocumentByUID(self.documentUID) {
            ...
            throw BartlebyOperationError.operationNotFound(UID: "DeleteBoxes: \(UID)")
        }
        throw BartlebyOperationError.documentNotFound(documentUID: "DeleteBoxes: \(documentUID)")
    }
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
            ...
            do {
                ...
                request(r).responseJSON(completionHandler: { response in
                    ...
                    let context = HTTPContext(code: 4_010_236_824,
                                              caller: "DeleteBoxes.execute",
