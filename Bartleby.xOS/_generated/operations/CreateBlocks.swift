...
@objc(CreateBlocks) public class CreateBlocks : BartlebyObject,BartlebyOperation{
    ...
    fileprivate var _blocks:[Block] = [Block]()

    fileprivate var _documentUID:String=Default.NO_UID

    required public convenience init(){
        self.init([Block](), inDocumentWithUID:Default.NO_UID)
    }
    ...
    override open var exposedKeys:[String] {
        ...
        exposed.append(contentsOf:["_blocks","_documentUID"])
        return exposed
    }
    ...
    required public init?(coder decoder: NSCoder) {
        ...
        self.silentGroupedChanges {
			self._blocks=decoder.decodeObject(of: [NSArray.classForCoder(),Block.classForCoder()], forKey: "_blocks")! as! [Block]
    ...
    override open func encode(with coder: NSCoder) {
		...
		coder.encode(self._blocks,forKey:"_blocks")
    ...
    */
    init (_ blocks:[Block]=[Block](), inDocumentWithUID documentUID:String) {
        self._blocks=blocks
    ...
    - parameter documentUID:     the document UID
    */
    static func commit(_ blocks:[Block], inDocumentWithUID documentUID:String){
        let operationInstance=CreateBlocks(blocks,inDocumentWithUID:documentUID)
        operationInstance.commit()
    }


    func commit(){
        let context=Context(code:4192090395, caller: "CreateBlocks.commit")
        if let document = Bartleby.sharedInstance.getDocumentByUID(self._documentUID) {
            ...
            do{
				...
				pushOperation.summary="CreateBlocks(\(stringIDS))"
               ...
               document.dispatchAdaptiveMessage(context,
                    ...
                    body: "Operation collection is missing in  CreateBlocks",
    ...
    open func push(sucessHandler success:@escaping (_ context:HTTPContext)->(),
        ...
        if  pushOperation.canBePushed(){
            ...
            CreateBlocks.execute(self._blocks,
    ...
    static open func execute(_ blocks:[Block],
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
                ...
                let urlRequest=HTTPManager.requestWithToken(inDocumentWithUID:document.UID,withActionName:"CreateBlocks" ,forMethod:"POST", and: pathURL)
                do {
                    ...
                    let context = HTTPContext( code: 3721792624,
                        caller: "CreateBlocks.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("creation  of blocks",
                            comment: "creation of blocks failure description")
                            ...
                            if let dictionary = result.value as? Dictionary< String,AnyObject > {
                                if let index=dictionary["triggerIndex"] as? NSNumber,
                                    let triggerRelayDuration=dictionary["triggerRelayDuration"] as? NSNumber{
										...
										acknowledgment.operationName="CreateBlocks"
