...
@objc public class CreateBlocks: ManagedModel, BartlebyOperation {
    ...
    static func commit(_ blocks: [Block], in document: BartlebyDocument) {
        ...
        let context = Context(code: 4_192_090_395, caller: "\(operationInstance.runTimeTypeName()).commit")
        do {
            ...
            pushOperation.operationName = CreateBlocks.typeName()
    ...
    open func push(sucessHandler success: @escaping (_ context: HTTPContext) -> Void,
        ...
        do {
            let blocks = try JSON.decoder.decode([Block].self, from: _payload ?? Data())
            ...
            if pushOperation.canBePushed() {
                ...
                referentDocument?.log("CreateBlocks can't be pushed \(pushOperation.status)", file: #file, function: #function, line: #line, category: Default.LOG_FAULT, decorative: false)
            }
        } catch {
    ...
    internal func _getOperation() throws -> PushOperation {
        if let document = Bartleby.sharedInstance.getDocumentByUID(self.documentUID) {
            ...
            throw BartlebyOperationError.operationNotFound(UID: "CreateBlocks: \(UID)")
        }
        throw BartlebyOperationError.documentNotFound(documentUID: "CreateBlocks: \(documentUID)")
    }
    ...
    open class func execute(_ blocks: [Block],
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
            ...
            for block in blocks {
                let serializedInstance = block.dictionaryRepresentation()
            ...
            do {
                ...
                request(r).responseJSON(completionHandler: { response in
                    ...
                    let context = HTTPContext(code: 3_721_792_624,
                                              caller: "CreateBlocks.execute",
