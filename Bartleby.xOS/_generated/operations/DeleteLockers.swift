...
@objc public class DeleteLockers: ManagedModel, BartlebyOperation {
    ...
    static func commit(_ lockers: [Locker], from document: BartlebyDocument) {
        ...
        let context = Context(code: 3_799_478_402, caller: "\(operationInstance.runTimeTypeName()).commit")
        do {
            ...
            pushOperation.operationName = DeleteLockers.typeName()
    ...
    open func push(sucessHandler success: @escaping (_ context: HTTPContext) -> Void,
        ...
        do {
            ...
            if pushOperation.canBePushed() {
                ...
                referentDocument?.log("DeleteLockers can't be pushed \(pushOperation.status)", file: #file, function: #function, line: #line, category: Default.LOG_FAULT, decorative: false)
            }
        } catch {
    ...
    internal func _getOperation() throws -> PushOperation {
        if let document = Bartleby.sharedInstance.getDocumentByUID(self.documentUID) {
            ...
            throw BartlebyOperationError.operationNotFound(UID: "DeleteLockers: \(UID)")
        }
        throw BartlebyOperationError.documentNotFound(documentUID: "DeleteLockers: \(documentUID)")
    }
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
            ...
            do {
                ...
                request(r).responseJSON(completionHandler: { response in
                    ...
                    let context = HTTPContext(code: 1_411_288_793,
                                              caller: "DeleteLockers.execute",
