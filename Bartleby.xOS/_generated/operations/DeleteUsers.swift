...
@objc(DeleteUsers) public class DeleteUsers : JObject,JHTTPCommand{
    ...
    */
    static func commit(ids:[String], fromRegistry registryUID:String){
        let operationInstance=DeleteUsers(ids,fromRegistry:registryUID)
    ...
    static public func execute(ids:[String],
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(registryUID) {
                ...
                parameters["ids"]=ids
                let urlRequest=HTTPManager.mutableRequestWithToken(inRegistry:document.UID,withActionName:"DeleteUsers" ,forMethod:"DELETE", and: pathURL)
