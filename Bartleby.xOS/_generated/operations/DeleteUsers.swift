...
@objc(DeleteUsers) public class DeleteUsers : BartlebyObject,BartlebyOperation{
    ...
    */
    ...
    open func push(sucessHandler success:@escaping (_ context:HTTPContext)->(),
        ...
        if let users = Mapper <User>().mapArray(JSONString:self._payload){
            do{
            ...
            glog("users should not be nil", file: #file, function: #function, line: #line, category: Default.LOG_DEVELOPER_CATEGORY, decorative: false)
        }
    }
