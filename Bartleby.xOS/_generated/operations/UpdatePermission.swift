    ...
    func commit(){
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(self._registryUID) {
            ...
            do{
                ...
                operation.summary="UpdatePermission(\(self._permission.UID))"
                ...
                Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
                    ...
                    body: "Operation collection is missing in  UpdatePermission",
            ...
            Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
                    ...
                    body: "\(m) registryUID =\(self._registryUID) in UpdatePermission",
                    onSelectedIndex: { (selectedIndex) -> () in
                    }
            )
        }
