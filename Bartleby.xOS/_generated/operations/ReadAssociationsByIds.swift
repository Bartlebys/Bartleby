...
import Foundation
	...
	import ObjectMapper
#endif
@objc(ReadAssociationsByIdsParameters) public class ReadAssociationsByIdsParameters : ManagedModel {
		// Universal type support
	override open class func typeName() -> String {
		 return "ReadAssociationsByIdsParameters"
	}
	// 
...
@objc(ReadAssociationsByIds) open class ReadAssociationsByIds : ManagedModel{

    // Universal type support
    override open class func typeName() -> String {
           return "ReadAssociationsByIds"
    }


    public static func execute(from documentUID:String,
						parameters:ReadAssociationsByIdsParameters,
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
            ...
            let urlRequest=HTTPManager.requestWithToken(inDocumentWithUID:document.UID,withActionName:"ReadAssociationsByIds" ,forMethod:"GET", and: pathURL)
            ...
            do {
                ...
                request(r).responseString(completionHandler: { (response) in
                    ...
                    let context = HTTPContext( code: 3954967028,
                        caller: "ReadAssociationsByIds.execute",
					...
					metrics.operationName="ReadAssociationsByIds"
