...
@objc public class DeleteTag : ManagedModel,BartlebyOperation{
    ...
    */
    static func commit(_ tag:Tag, from document:BartlebyDocument){
        ...
        do{
            ...
            pushOperation.operationName = DeleteTag.typeName()
        ...
        failureHandler failure:@escaping (_ context:HTTPContext)->()){
            do{
                ...
                if  pushOperation.canBePushed(){
                    ...
                    self.referentDocument?.log("DeleteTag can't be pushed \(pushOperation.status)", file: #file, function: #function, line: #line, category: Default.LOG_FAULT, decorative: false)
                }
            }catch{
    ...
    internal func _getOperation()throws->PushOperation{
        if let document = Bartleby.sharedInstance.getDocumentByUID(self.documentUID) {
            ...
            throw BartlebyOperationError.operationNotFound(UID:"DeleteTag: \(self.UID)")
        }
        throw BartlebyOperationError.documentNotFound(documentUID:"DeleteTag: \(self.documentUID)")
    }
