...
@objc(UpdateUsers) public class UpdateUsers : BartlebyObject,JHTTPCommand{
    ...
    */
    ...
    static open func execute(_ users:[User],
            ...
            if let document = Bartleby.sharedInstance.getDocumentByUID(registryUID) {
                ...
                let urlRequest=HTTPManager.requestWithToken(inRegistryWithUID:document.UID,withActionName:"UpdateUsers" ,forMethod:"PUT", and: pathURL)
                do {
