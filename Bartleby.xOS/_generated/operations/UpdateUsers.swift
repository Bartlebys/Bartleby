...
@objc public class UpdateUsers: ManagedModel, BartlebyOperation {
    ...
    static func commit(_ users: [User], in document: BartlebyDocument) {
        ...
        let context = Context(code: 3_977_846_924, caller: "\(operationInstance.runTimeTypeName()).commit")
        do {
    ...
    open func push(sucessHandler success: @escaping (_ context: HTTPContext) -> Void,
        ...
        do {
            ...
            if pushOperation.canBePushed() {
                ...
                referentDocument?.log("UpdateUsers can't be pushed \(pushOperation.status)", file: #file, function: #function, line: #line, category: Default.LOG_FAULT, decorative: false)
            }
        } catch {
    ...
    internal func _getOperation() throws -> PushOperation {
        if let document = Bartleby.sharedInstance.getDocumentByUID(self.documentUID) {
            ...
            throw BartlebyOperationError.operationNotFound(UID: "UpdateUsers: \(UID)")
        }
        throw BartlebyOperationError.documentNotFound(documentUID: "UpdateUsers: \(documentUID)")
    }
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
            ...
            do {
                ...
                request(r).responseJSON(completionHandler: { response in
                    ...
                    let context = HTTPContext(code: 3_014_249_870,
                                              caller: "UpdateUsers.execute",
