...
@objc public class UpdateNodes: ManagedModel, BartlebyOperation {
    ...
    static func commit(_ nodes: [Node], in document: BartlebyDocument) {
        ...
        let context = Context(code: 320_633_844, caller: "\(operationInstance.runTimeTypeName()).commit")
        do {
    ...
    open func push(sucessHandler success: @escaping (_ context: HTTPContext) -> Void,
        ...
        do {
            ...
            if pushOperation.canBePushed() {
                ...
                referentDocument?.log("UpdateNodes can't be pushed \(pushOperation.status)", file: #file, function: #function, line: #line, category: Default.LOG_FAULT, decorative: false)
            }
        } catch {
    ...
    internal func _getOperation() throws -> PushOperation {
        if let document = Bartleby.sharedInstance.getDocumentByUID(self.documentUID) {
            ...
            throw BartlebyOperationError.operationNotFound(UID: "UpdateNodes: \(UID)")
        }
        throw BartlebyOperationError.documentNotFound(documentUID: "UpdateNodes: \(documentUID)")
    }
        ...
        if let document = Bartleby.sharedInstance.getDocumentByUID(documentUID) {
            ...
            do {
                ...
                request(r).responseJSON(completionHandler: { response in
                    ...
                    let context = HTTPContext(code: 3_985_191_387,
                                              caller: "UpdateNodes.execute",
