...
@objc(UpdateNodes) public class UpdateNodes : BartlebyObject,BartlebyOperation{
    ...
    */
    static func commit(_ nodes:[Node], inDocumentWithUID documentUID:String){
        let operationInstance=UpdateNodes(nodes,inDocumentWithUID:documentUID)
        operationInstance.commit()
    }


    func commit(){
        let context=Context(code:320633844, caller: "UpdateNodes.commit")
        if let document = Bartleby.sharedInstance.getDocumentByUID(self._documentUID) {
            ...
            do{
				...
				pushOperation.summary="UpdateNodes(\(stringIDS))"
               ...
               document.dispatchAdaptiveMessage(context,
                    ...
                    body: "Operation collection is missing in  UpdateNodes",
    ...
    open func push(sucessHandler success:@escaping (_ context:HTTPContext)->(),
        ...
        if  pushOperation.canBePushed(){
            ...
            UpdateNodes.execute(self._nodes,
