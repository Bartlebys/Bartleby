...
@objc(GroupsCollectionController) public class GroupsCollectionController : JObject,IterableCollectibleCollection{
    ...
    public func indexOf(@noescape predicate: (Group) throws -> Bool) rethrows -> Int?{
        return try self.items.indexOf(predicate)
    }

    public func indexOf(element: Group) -> Int?{
    ...
    */
    ...
    public dynamic var items:[Group]=[Group](){
        didSet {
            if items != oldValue {
            ...
            if let arrayController = self.arrayController{
                ...
                if let tableView = self.tableView{
                    dispatch_async(GlobalQueue.Main.get(), {
                        let sorted=self.arrayController?.arrangedObjects as! [Group]
