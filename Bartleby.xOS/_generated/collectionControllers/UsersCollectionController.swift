...
@objc(UsersCollectionController) open class UsersCollectionController : JObject,IterableCollectibleCollection{
    ...
    open func makeIterator() -> AnyIterator<User> {
        var nextIndex = -1
    ...
    open func indexOf(_ element: User) -> Int?{
    ...
    */
    ...
    required public init?(coder decoder: NSCoder) {
        ...
        self.disableSupervisionAndCommit()
		self.items=decoder.decodeObject(of: NSSet(array: [NSArray.classForCoder(),User.classForCoder()]), forKey: "items")! as! [User]
