...
@objc(TasksCollectionController) public class TasksCollectionController : JObject,IterableCollectibleCollection{
    ...
    public func indexOf(@noescape predicate: (Task) throws -> Bool) rethrows -> Int?{
        return try self.items.indexOf(predicate)
    }

    public func indexOf(element: Task) -> Int?{
    ...
    */
    ...
    public dynamic var items:[Task]=[Task](){
        didSet {
            if items != oldValue {
            ...
            if let arrayController = self.arrayController{
                ...
                if let tableView = self.tableView{
                    dispatch_async(GlobalQueue.Main.get(), {
                        let sorted=self.arrayController?.arrangedObjects as! [Task]
