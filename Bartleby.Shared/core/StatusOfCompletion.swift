...
/*
    ...
    /**
     Maps Exit code to StatusOfCompletion  , HTTP codes

     - parameter value: the value

     - returns: the status
     */
    static func statusOfCompletionFromExitCodes(value: Int32) -> StatusOfCompletion  {
        /*
        ...
        switch value {
        case EX_OK:
            return StatusOfCompletion.OK
        case EX__BASE:
            return StatusOfCompletion.Bad_Request
        case EX_USAGE:
            return StatusOfCompletion.Not_Acceptable
        case EX_DATAERR:
            return StatusOfCompletion.Not_Acceptable
        case EX_NOINPUT:
            return StatusOfCompletion.Not_Found
        case EX_NOUSER:
            return StatusOfCompletion.Not_Acceptable
        case EX_NOHOST:
            return StatusOfCompletion.Not_Found
        case EX_UNAVAILABLE:
            return StatusOfCompletion.Not_Found
        case EX_SOFTWARE:
            return StatusOfCompletion.Internal_Server_Error
        case EX_OSERR:
            return StatusOfCompletion.Internal_Server_Error
        case EX_OSFILE:
            return StatusOfCompletion.Internal_Server_Error
        ...
        case EX_IOERR:
            return StatusOfCompletion.Internal_Server_Error
        case EX_TEMPFAIL:
            return StatusOfCompletion.Expectation_Failed
        case EX_PROTOCOL:
            return StatusOfCompletion.Expectation_Failed
        case EX_NOPERM:
            return StatusOfCompletion.Unauthorized
        case EX_CONFIG:
            return StatusOfCompletion.Precondition_Failed
        case EX__MAX:
            return StatusOfCompletion.Internal_Server_Error
        default:
            return StatusOfCompletion.Error
        }
    ...
    static func statusOfCompletionFromExitCodes(value: Int) -> StatusOfCompletion  {
        return statusOfCompletionFromExitCodes(Int32(value))
    }
