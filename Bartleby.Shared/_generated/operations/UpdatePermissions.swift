...
@objc(UpdatePermissions) public class UpdatePermissions : JObject,JHTTPCommand{
    ...
    */
    ...
    func commit(){
        ...
        if let registry = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
				...
				let stringIDS=self._permissions.reduce("", combine: { $0+","+$1.UID })
				self._operation.summary="UpdatePermissions(\(stringIDS))"
