...
@objc(UpdatePermissions) public class UpdatePermissions : JObject,JHTTPCommand{
    ...
    */
    init (_ permissions:[Permission]=[Permission](), inDataSpace spaceUID:String) {
    ...
    - parameter spaceUID:     the space UID
    */
    static func commit(permissions:[Permission], inDataSpace spaceUID:String){
        let operationInstance=UpdatePermissions(permissions,inDataSpace:spaceUID)
