...
@objc(DeleteLocker) public class DeleteLocker : JObject,JHTTPCommand{
    ...
    */
    init (_ lockerId:String=String(), fromDataSpace spaceUID:String) {
    ...
    - parameter spaceUID:     the space UID
    */
    static func commit(lockerId:String, fromDataSpace spaceUID:String){
        let operationInstance=DeleteLocker(lockerId,fromDataSpace:spaceUID)
