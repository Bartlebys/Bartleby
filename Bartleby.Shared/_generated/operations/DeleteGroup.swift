...
@objc(DeleteGroup) public class DeleteGroup : JObject,JHTTPCommand{
    ...
    */
    init (_ groupId:String=String(), fromDataSpace spaceUID:String) {
    ...
    - parameter spaceUID:     the space UID
    */
    static func commit(groupId:String, fromDataSpace spaceUID:String){
        let operationInstance=DeleteGroup(groupId,fromDataSpace:spaceUID)
