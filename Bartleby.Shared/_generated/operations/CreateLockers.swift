...
@objc(CreateLockers) public class CreateLockers : JObject,JHTTPCommand{
    ...
    required public convenience init(){
        self.init([Locker](), inDataSpace:Default.NO_UID)
    }
    ...
    */
    init (_ lockers:[Locker]=[Locker](), inDataSpace spaceUID:String) {
    ...
    - parameter spaceUID:     the space UID
    */
    static func commit(lockers:[Locker], inDataSpace spaceUID:String){
        let operationInstance=CreateLockers(lockers,inDataSpace:spaceUID)
