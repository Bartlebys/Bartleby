...
public class UpdateTask : JObject,JHTTPCommand{
    ...
    */
    static func commit(task:Task, inDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=UpdateTask(task,inDataSpace:spaceUID,observableBy:observationUID)
        operationInstance.commit()
    }


    func commit(){
        let context=Context(code:1768251054, caller: "UpdateTask.commit")
    ...
    public func push(sucessHandler success:(context:HTTPResponse)->(),
        ...
        if let _ = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            ...
            if  self._operation.status==Operation.Status.Pending ||
                ...
                // This registry is not available there is nothing to do.
                let context=Context(code:149506460, caller: "UpdateTask.push")
                Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
...
inDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inDataSpace:spaceUID,withActionName:"UpdateTask" ,forMethod:"PUT", and: pathURL)
                ...
                r.responseString{ response in
                    ...
                    let context = JHTTPResponse( code: 1716383764,
                        caller: "UpdateTask.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("update  of task",
                            comment: "update of task failure description")
