...
@objc(UpdateTriggers) public class UpdateTriggers : JObject,JHTTPCommand{
    ...
    required public convenience init(){
        self.init([Trigger](), inDataSpace:Default.NO_UID)
    }
    ...
    */
    init (_ triggers:[Trigger]=[Trigger](), inDataSpace spaceUID:String) {
    ...
    - parameter spaceUID:     the space UID
    */
    static func commit(triggers:[Trigger], inDataSpace spaceUID:String){
        let operationInstance=UpdateTriggers(triggers,inDataSpace:spaceUID)
