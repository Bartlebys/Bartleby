...
@objc(UpdateTriggers) public class UpdateTriggers : JObject,JHTTPCommand{
    ...
    required public init?(coder decoder: NSCoder) {
		...
		self._triggers=decoder.decodeObjectOfClasses(NSSet(array: [NSArray.classForCoder(),Trigger.classForCoder()]), forKey: "_triggers")! as! [Trigger]
    ...
    override public func encodeWithCoder(coder: NSCoder) {
		...
		coder.encodeObject(self._triggers,forKey:"_triggers")
    ...
    */
    ...
    func commit(){
        ...
        if let registry = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
                ...
                let stringIDS=PString.ltrim(self._triggers.reduce("", combine: { $0+","+$1.UID }),characters:",")
                self._operation.summary="UpdateTriggers(\(stringIDS))"
