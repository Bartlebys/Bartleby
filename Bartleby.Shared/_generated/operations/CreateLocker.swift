...
@objc(CreateLocker) public class CreateLocker : JObject,JHTTPCommand{
    ...
    */
    init (_ locker:Locker=Locker(), inDataSpace spaceUID:String) {
        self._locker=locker
    ...
    - parameter spaceUID:     the space UID
    */
    static func commit(locker:Locker, inDataSpace spaceUID:String){
        let operationInstance=CreateLocker(locker,inDataSpace:spaceUID)
