...
@objc(UpdateTasksGroups) public class UpdateTasksGroups : JObject,JHTTPCommand{

    // Universal type support
    override public class func typeName() -> String {
        return "UpdateTasksGroups"
    }
    ...
    */
    static func commit(tasksGroups:[TasksGroup], inDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=UpdateTasksGroups(tasksGroups,inDataSpace:spaceUID,observableBy:observationUID)
        operationInstance.commit()
    }


    func commit(){
        let context=Context(code:3693502696, caller: "UpdateTasksGroups.commit")
    ...
    public func push(sucessHandler success:(context:HTTPResponse)->(),
        ...
        if let _ = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            ...
            if  self._operation.status==Operation.Status.Pending ||
                ...
                UpdateTasksGroups.execute(self._tasksGroups,
                ...
                // This registry is not available there is nothing to do.
                let context=Context(code:4032915729, caller: "UpdateTasksGroups.push")
                Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
...
inDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inDataSpace:spaceUID,withActionName:"UpdateTasksGroups" ,forMethod:"PUT", and: pathURL)
                ...
                r.responseString{ response in
                    ...
                    let context = JHTTPResponse( code: 4182202255,
                        caller: "UpdateTasksGroups.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("update  of tasksGroups",
                            comment: "update of tasksGroups failure description")
