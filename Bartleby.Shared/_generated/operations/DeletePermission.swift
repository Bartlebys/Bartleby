...
@objc(DeletePermission) public class DeletePermission : JObject,JHTTPCommand{
    ...
    */
    init (_ permissionId:String=String(), fromDataSpace spaceUID:String) {
    ...
    - parameter spaceUID:     the space UID
    */
    static func commit(permissionId:String, fromDataSpace spaceUID:String){
        let operationInstance=DeletePermission(permissionId,fromDataSpace:spaceUID)
