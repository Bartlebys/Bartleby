...
@objc(UpdateTrigger) public class UpdateTrigger : JObject,JHTTPCommand{
    ...
    */
    init (_ trigger:Trigger=Trigger(), inDataSpace spaceUID:String) {
    ...
    - parameter spaceUID:     the space UID
    */
    static func commit(trigger:Trigger, inDataSpace spaceUID:String){
        let operationInstance=UpdateTrigger(trigger,inDataSpace:spaceUID)
