...
@objc(UpdateTrigger) public class UpdateTrigger : JObject,JHTTPCommand{
    ...
    required public init?(coder decoder: NSCoder) {
		...
		self._trigger=decoder.decodeObjectOfClass(Trigger.self, forKey: "_trigger")! 
    ...
    override public func encodeWithCoder(coder: NSCoder) {
		...
		coder.encodeObject(self._trigger,forKey:"_trigger")
    ...
    */
    ...
    func commit(){
        ...
        if let registry = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
                ...
                self._operation.summary="UpdateTrigger(\(self._trigger.UID))"
