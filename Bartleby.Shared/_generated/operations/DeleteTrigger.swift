...
@objc(DeleteTrigger) public class DeleteTrigger : JObject,JHTTPCommand{
    ...
    override public func mapping(map: Map) {
        super.mapping(map)
		self._triggerId <- map["_triggerId"]
    ...
    required public init?(coder decoder: NSCoder) {
		...
		self._triggerId=String(decoder.decodeObjectOfClass(NSString.self, forKey: "_triggerId")! as NSString)
    ...
    override public func encodeWithCoder(coder: NSCoder) {
		...
		coder.encodeObject(self._triggerId,forKey:"_triggerId")
    ...
    */
    ...
    func commit(){
        ...
        if let registry = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
                ...
                self._operation.summary="DeleteTrigger(\(self._triggerId))"
