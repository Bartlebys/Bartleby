...
@objc(DeleteTrigger) public class DeleteTrigger : JObject,JHTTPCommand{
    ...
    required public convenience init(){
        self.init(String(), fromDataSpace:Default.NO_UID)
    }
    ...
    */
    init (_ triggerId:String=String(), fromDataSpace spaceUID:String) {
    ...
    - parameter spaceUID:     the space UID
    */
    static func commit(triggerId:String, fromDataSpace spaceUID:String){
        let operationInstance=DeleteTrigger(triggerId,fromDataSpace:spaceUID)
