...
@objc(UpdatePermission) public class UpdatePermission : JObject,JHTTPCommand{
    ...
    */
    static func commit(permission:Permission, inDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=UpdatePermission(permission,inDataSpace:spaceUID,observableBy:observationUID)
    ...
    func commit(){
        ...
        if let registry = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
				...
				self._operation.summary="UpdatePermission(\(self._permission.UID))"
    ...
    public func push(sucessHandler success:(context:HTTPResponse)->(),
        ...
        if let _ = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            ...
            if  self._operation.status==Operation.Status.Pending ||
                ...
                // This registry is not available there is nothing to do.
                let context=Context(code:4150882059, caller: "UpdatePermission.push")
                Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
...
inDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                r.responseString{ response in
                    ...
                    let context = JHTTPResponse( code: 2960613018,
                        caller: "UpdatePermission.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("update  of permission",
                            comment: "update of permission failure description")
