...
public class DeleteTask : JObject,JHTTPCommand{
    ...
    required public init?(coder decoder: NSCoder) {
		...
		self._taskId=String(decoder.decodeObjectOfClass(NSString.self, forKey: "_taskId")! as NSString)
    ...
    override public func encodeWithCoder(coder: NSCoder) {
		...
		coder.encodeObject(self._taskId,forKey:"_taskId")
    ...
    - parameter taskId: the taskId concerned the operation
    ...
    */
    init (_ taskId:String=String(), fromDataSpace spaceUID:String,observableBy observationUID:String=Default.NOT_OBSERVABLE) {
        self._taskId=taskId
    ...
    - parameter taskId: the instance
    - parameter spaceUID:     the space UID
    - parameter oID:     the observable UID
    */
    static func commit(taskId:String, fromDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=DeleteTask(taskId,fromDataSpace:spaceUID,observableBy:observationUID)
        operationInstance.commit()
    }


    func commit(){
        let context=Context(code:3016338564, caller: "DeleteTask.commit")
    ...
    public func push(sucessHandler success:(context:HTTPResponse)->(),
        ...
        if let _ = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            ...
            if  self._operation.status==Operation.Status.Pending ||
                ...
                DeleteTask.execute(self._taskId,
                ...
                // This registry is not available there is nothing to do.
                let context=Context(code:1315223336, caller: "DeleteTask.push")
                Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
    ...
    static public func execute(taskId:String,
fromDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inDataSpace:spaceUID,withActionName:"DeleteTask" ,forMethod:"DELETE", and: pathURL)
                ...
                r.responseString{ response in
                    ...
                    let context = JHTTPResponse( code: 3173815600,
                        caller: "DeleteTask.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("deleteById  of task",
                            comment: "deleteById of task failure description")
