...
@objc(DeleteTasksGroup) public class DeleteTasksGroup : JObject,JHTTPCommand{

    // Universal type support
    override public class func typeName() -> String {
        return "DeleteTasksGroup"
    }

    private var _tasksGroupId:String = String()
    ...
    override public func mapping(map: Map) {
        super.mapping(map)
		self._tasksGroupId <- map["_tasksGroupId"]
    ...
    required public init?(coder decoder: NSCoder) {
		...
		self._tasksGroupId=String(decoder.decodeObjectOfClass(NSString.self, forKey: "_tasksGroupId")! as NSString)
    ...
    override public func encodeWithCoder(coder: NSCoder) {
		...
		coder.encodeObject(self._tasksGroupId,forKey:"_tasksGroupId")
    ...
    - parameter tasksGroupId: the tasksGroupId concerned the operation
    ...
    */
    init (_ tasksGroupId:String=String(), fromDataSpace spaceUID:String,observableBy observationUID:String=Default.NOT_OBSERVABLE) {
        self._tasksGroupId=tasksGroupId
    ...
    - parameter tasksGroupId: the instance
    - parameter spaceUID:     the space UID
    - parameter oID:     the observable UID
    */
    static func commit(tasksGroupId:String, fromDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=DeleteTasksGroup(tasksGroupId,fromDataSpace:spaceUID,observableBy:observationUID)
        operationInstance.commit()
    }


    func commit(){
        let context=Context(code:1966111192, caller: "DeleteTasksGroup.commit")
    ...
    public func push(sucessHandler success:(context:HTTPResponse)->(),
        ...
        if let _ = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            ...
            if  self._operation.status==Operation.Status.Pending ||
                ...
                DeleteTasksGroup.execute(self._tasksGroupId,
                ...
                // This registry is not available there is nothing to do.
                let context=Context(code:1297013375, caller: "DeleteTasksGroup.push")
                Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
    ...
    static public func execute(tasksGroupId:String,
fromDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                parameters["tasksGroupId"]=tasksGroupId
                let urlRequest=HTTPManager.mutableRequestWithToken(inDataSpace:spaceUID,withActionName:"DeleteTasksGroup" ,forMethod:"DELETE", and: pathURL)
                ...
                r.responseString{ response in
                    ...
                    let context = JHTTPResponse( code: 3744952634,
                        caller: "DeleteTasksGroup.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("deleteById  of tasksGroup",
                            comment: "deleteById of tasksGroup failure description")
