...
@objc(DeleteTriggers) public class DeleteTriggers : JObject,JHTTPCommand{
    ...
    */
    ...
    func commit(){
        ...
        if let registry = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
				...
				let stringIDS=self._ids.reduce("", combine: { $0+","+$1 })
				self._operation.summary="DeleteTriggers(\(stringIDS))"
