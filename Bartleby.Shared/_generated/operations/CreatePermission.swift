...
@objc(CreatePermission) public class CreatePermission : JObject,JHTTPCommand{
    ...
    */
    init (_ permission:Permission=Permission(), inDataSpace spaceUID:String,observableBy observationUID:String=Default.NOT_OBSERVABLE) {
    ...
    */
    static func commit(permission:Permission, inDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=CreatePermission(permission,inDataSpace:spaceUID,observableBy:observationUID)
            ...
            if  self._operation.status==Operation.Status.Pending ||
                ...
                CreatePermission.execute(self._permission,
                    ...
                    sucessHandler: { (context: JHTTPResponse) -> () in
                        registry.markAsDistributed(&self._permission)
