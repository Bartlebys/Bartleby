...
import ObjectMapper
#endif
@objc(DeletePermission) public class DeletePermission : BaseObject,JHTTPCommand{
    ...
    override public func mapping(map: Map) {
        super.mapping(map)
		_permissionId <- map["_permissionId"]
    ...
    required public init?(coder decoder: NSCoder) {
		...
		_permissionId=String(decoder.decodeObjectOfClass(NSString.self, forKey: "_permissionId")! as NSString)
    ...
    override public func encodeWithCoder(coder: NSCoder) {
		...
		coder.encodeObject(_permissionId,forKey:"_permissionId")
    ...
    */
    init (_ permissionId:String=String(), fromDataSpace spaceUID:String,observableBy observationUID:String=Default.NOT_OBSERVABLE) {
    ...
    */
    static func commit(permissionId:String, fromDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=DeletePermission(permissionId,fromDataSpace:spaceUID,observableBy:observationUID)
    ...
    func commit(){
        ...
        if let registry = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            //if registry.deleteById(self._permissionId, fromCollectionWithName:"permissions"){                // Prepare the operation
