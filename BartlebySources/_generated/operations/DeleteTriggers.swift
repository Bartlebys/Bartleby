...
import ObjectMapper
#endif
@objc(DeleteTriggers) public class DeleteTriggers : BaseObject,JHTTPCommand{
    ...
    */
    static func commit(ids:[String], fromDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=DeleteTriggers(ids,fromDataSpace:spaceUID,observableBy:observationUID)
        operationInstance.commit()
    }


    func commit(){
        let context=Context(code:1999989226, caller: "DeleteTriggers.commit")
        if let registry = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            //if registry.deleteByIds(self._ids, fromCollectionWithName:"triggers"){                // Prepare the operation
    ...
    public func push(sucessHandler success:(context:HTTPResponse)->(),
        ...
        if let _ = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            ...
            if  self._operation.status==Operation.Status.Pending ||
                ...
                DeleteTriggers.execute(self._ids,
                ...
                // This registry is not available there is nothing to do.
                let context=Context(code:331735469, caller: "DeleteTriggers.push")
                Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
...
fromDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                parameters["ids"]=ids
                let urlRequest=HTTPManager.mutableRequestWithToken(inDataSpace:spaceUID,withActionName:"DeleteTriggers" ,forMethod:"DELETE", and: pathURL)
                ...
                r.responseString{ response in
                    ...
                    let context = JHTTPResponse( code: 400696746,
                        caller: "DeleteTriggers.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("deleteByIds  of triggers",
                            comment: "deleteByIds of triggers failure description")
