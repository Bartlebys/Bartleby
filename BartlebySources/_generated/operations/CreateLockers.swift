...
import ObjectMapper
#endif
@objc(CreateLockers) public class CreateLockers : BaseObject,JHTTPCommand{
    ...
    required public convenience init(){
        self.init([Locker](), inDataSpace:Default.NO_UID,observableBy:Default.NOT_OBSERVABLE)
    }
    ...
    required public init?(coder decoder: NSCoder) {
		...
		_lockers=decoder.decodeObjectOfClasses(NSSet(array: [NSArray.classForCoder(),Locker.classForCoder()]), forKey: "_lockers")! as! [Locker]
    ...
    override public func encodeWithCoder(coder: NSCoder) {
		...
		coder.encodeObject(_lockers,forKey:"_lockers")
    ...
    */
    init (_ lockers:[Locker]=[Locker](), inDataSpace spaceUID:String,observableBy observationUID:String=Default.NOT_OBSERVABLE) {
    ...
    */
    static func commit(lockers:[Locker], inDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=CreateLockers(lockers,inDataSpace:spaceUID,observableBy:observationUID)
    ...
    func commit(){
        ...
        if let registry = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            //if registry.upsert(self._lockers){                // Prepare the operation
            ...
            if  self._operation.status==Operation.Status.Pending ||
                ...
                CreateLockers.execute(self._lockers,
                    ...
                    sucessHandler: { (context: JHTTPResponse) -> () in
                        registry.markAsDistributed(&self._lockers)
                ...
                // This registry is not available there is nothing to do.
                let context=Context(code:2738673496, caller: "CreateLockers.push")
                Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
...
inDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inDataSpace:spaceUID,withActionName:"CreateLockers" ,forMethod:"POST", and: pathURL)
