...
import ObjectMapper
#endif
@objc(UpdateTrigger) public class UpdateTrigger : BaseObject,JHTTPCommand{
    ...
    */
    static func commit(trigger:Trigger, inDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=UpdateTrigger(trigger,inDataSpace:spaceUID,observableBy:observationUID)
        operationInstance.commit()
    }


    func commit(){
        let context=Context(code:1750384337, caller: "UpdateTrigger.commit")
    ...
    public func push(sucessHandler success:(context:HTTPResponse)->(),
        ...
        if let _ = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            ...
            if  self._operation.status==Operation.Status.Pending ||
                ...
                UpdateTrigger.execute(self._trigger,
                ...
                // This registry is not available there is nothing to do.
                let context=Context(code:1289171224, caller: "UpdateTrigger.push")
                Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
...
inDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inDataSpace:spaceUID,withActionName:"UpdateTrigger" ,forMethod:"PUT", and: pathURL)
                ...
                r.responseString{ response in
                    ...
                    let context = JHTTPResponse( code: 2801184089,
                        caller: "UpdateTrigger.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("update  of trigger",
                            comment: "update of trigger failure description")
