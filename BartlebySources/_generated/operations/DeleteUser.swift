...
@objc(DeleteUser) public class DeleteUser : BaseObject,JHTTPCommand{
    ...
    required public init?(coder decoder: NSCoder) {
		...
		_userId=String(decoder.decodeObjectOfClass(NSString.self, forKey: "_userId")! as NSString)
    ...
    override public func encodeWithCoder(coder: NSCoder) {
		...
		coder.encodeObject(_userId,forKey:"_userId")
    ...
    */
    ...
    func commit(){
        ...
        if let registry = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            //if registry.deleteById(self._userId, fromCollectionWithName:"users"){                // Prepare the operation
