...
import ObjectMapper
#endif
@objc(UpdateGroup) public class UpdateGroup : BaseObject,JHTTPCommand{
    ...
    */
    static func commit(group:Group, inDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=UpdateGroup(group,inDataSpace:spaceUID,observableBy:observationUID)
    ...
    func commit(){
        ...
        if let registry = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            //if registry.upsert(self._group){                // Prepare the operation
...
inDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inDataSpace:spaceUID,withActionName:"UpdateGroup" ,forMethod:"PUT", and: pathURL)
