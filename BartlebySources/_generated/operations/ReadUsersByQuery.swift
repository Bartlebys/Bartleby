...
import ObjectMapper
#endif
@objc(ReadUsersByQueryParameters) public class ReadUsersByQueryParameters : BaseObject {
	// 
...
@objc(ReadUsersByQuery) public class ReadUsersByQuery : BaseObject{
    ...
    public static func execute(fromDataSpace spaceUID:String,
				    ...
				    let urlRequest=HTTPManager.mutableRequestWithToken(inDataSpace:spaceUID,withActionName:"ReadUsersByQuery" ,forMethod:"POST", and: pathURL)
