...
import ObjectMapper
#endif
@objc(UpdateLocker) public class UpdateLocker : BaseObject,JHTTPCommand{
    ...
    */
    static func commit(locker:Locker, inDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=UpdateLocker(locker,inDataSpace:spaceUID,observableBy:observationUID)
