...
import ObjectMapper
#endif
@objc(DeleteUsers) public class DeleteUsers : BaseObject,JHTTPCommand{
    ...
    */
    static func commit(ids:[String], fromDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=DeleteUsers(ids,fromDataSpace:spaceUID,observableBy:observationUID)
    ...
    func commit(){
        ...
        if let registry = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            //if registry.deleteByIds(self._ids, fromCollectionWithName:"users"){                // Prepare the operation
...
fromDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                parameters["ids"]=ids
                let urlRequest=HTTPManager.mutableRequestWithToken(inDataSpace:spaceUID,withActionName:"DeleteUsers" ,forMethod:"DELETE", and: pathURL)
