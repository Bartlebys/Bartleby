...
@objc(CreateLocker) public class CreateLocker : BaseObject,JHTTPCommand{
    ...
    required public init?(coder decoder: NSCoder) {
		...
		_locker=decoder.decodeObjectOfClass(Locker.self, forKey: "_locker")! 
    ...
    override public func encodeWithCoder(coder: NSCoder) {
		...
		coder.encodeObject(_locker,forKey:"_locker")
    ...
    */
    init (_ locker:Locker=Locker(), inDataSpace spaceUID:String,observableBy observationUID:String=Default.NOT_OBSERVABLE) {
        self._locker=locker
    ...
    */
    static func commit(locker:Locker, inDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=CreateLocker(locker,inDataSpace:spaceUID,observableBy:observationUID)
    ...
    func commit(){
        ...
        if let registry = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            //if registry.upsert(self._locker){                // Prepare the operation
            ...
            if  self._operation.status==Operation.Status.Pending ||
                ...
                CreateLocker.execute(self._locker,
                    ...
                    sucessHandler: { (context: JHTTPResponse) -> () in
                        registry.markAsDistributed(&self._locker)
...
inDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inDataSpace:spaceUID,withActionName:"CreateLocker" ,forMethod:"POST", and: pathURL)
