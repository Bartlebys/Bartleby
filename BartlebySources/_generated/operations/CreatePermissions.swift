...
import ObjectMapper
#endif
@objc(CreatePermissions) public class CreatePermissions : BaseObject,JHTTPCommand{
    ...
    */
    static func commit(permissions:[Permission], inDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=CreatePermissions(permissions,inDataSpace:spaceUID,observableBy:observationUID)
            ...
            if  self._operation.status==Operation.Status.Pending ||
                ...
                CreatePermissions.execute(self._permissions,
                    ...
                    sucessHandler: { (context: JHTTPResponse) -> () in
                        registry.markAsDistributed(&self._permissions)
...
inDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inDataSpace:spaceUID,withActionName:"CreatePermissions" ,forMethod:"POST", and: pathURL)
