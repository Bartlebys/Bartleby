...
import ObjectMapper
#endif
@objc(UpdateAliases) public class UpdateAliases : BaseObject,JHTTPCommand{
    ...
    */
    static func commit(aliases:[Alias], inDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=UpdateAliases(aliases,inDataSpace:spaceUID,observableBy:observationUID)
        operationInstance.commit()
    }


    func commit(){
        let context=Context(code:3472797173, caller: "UpdateAliases.commit")
    ...
    public func push(sucessHandler success:(context:HTTPResponse)->(),
        ...
        if let _ = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            ...
            if  self._operation.status==Operation.Status.Pending ||
                ...
                UpdateAliases.execute(self._aliases,
                ...
                // This registry is not available there is nothing to do.
                let context=Context(code:1683739079, caller: "UpdateAliases.push")
                Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
...
inDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inDataSpace:spaceUID,withActionName:"UpdateAliases" ,forMethod:"PUT", and: pathURL)
                ...
                r.responseString{ response in
                    ...
                    let context = JHTTPResponse( code: 2589189019,
                        caller: "UpdateAliases.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("update  of aliases",
                            comment: "update of aliases failure description")
