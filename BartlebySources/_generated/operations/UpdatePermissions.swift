...
import ObjectMapper
#endif
@objc(UpdatePermissions) public class UpdatePermissions : BaseObject,JHTTPCommand{
    ...
    required public convenience init(){
        self.init([Permission](), inDataSpace:Default.NO_UID,observableBy:Default.NOT_OBSERVABLE)
    }
    ...
    required public init?(coder decoder: NSCoder) {
		...
		_permissions=decoder.decodeObjectOfClasses(NSSet(array: [NSArray.classForCoder(),Permission.classForCoder()]), forKey: "_permissions")! as! [Permission]
    ...
    override public func encodeWithCoder(coder: NSCoder) {
		...
		coder.encodeObject(_permissions,forKey:"_permissions")
    ...
    */
    init (_ permissions:[Permission]=[Permission](), inDataSpace spaceUID:String,observableBy observationUID:String=Default.NOT_OBSERVABLE) {
    ...
    */
    static func commit(permissions:[Permission], inDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=UpdatePermissions(permissions,inDataSpace:spaceUID,observableBy:observationUID)
        operationInstance.commit()
    }


    func commit(){
        let context=Context(code:2093988578, caller: "UpdatePermissions.commit")
    ...
    public func push(sucessHandler success:(context:HTTPResponse)->(),
        ...
        if let _ = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            ...
            if  self._operation.status==Operation.Status.Pending ||
                ...
                UpdatePermissions.execute(self._permissions,
                ...
                // This registry is not available there is nothing to do.
                let context=Context(code:2870516633, caller: "UpdatePermissions.push")
                Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
...
inDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inDataSpace:spaceUID,withActionName:"UpdatePermissions" ,forMethod:"PUT", and: pathURL)
                ...
                r.responseString{ response in
                    ...
                    let context = JHTTPResponse( code: 422729547,
                        caller: "UpdatePermissions.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("update  of permissions",
                            comment: "update of permissions failure description")
