...
import ObjectMapper
#endif
@objc(UpdateLockers) public class UpdateLockers : BaseObject,JHTTPCommand{
    ...
    */
    static func commit(lockers:[Locker], inDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=UpdateLockers(lockers,inDataSpace:spaceUID,observableBy:observationUID)
...
inDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inDataSpace:spaceUID,withActionName:"UpdateLockers" ,forMethod:"PUT", and: pathURL)
