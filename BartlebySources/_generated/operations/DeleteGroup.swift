...
import ObjectMapper
#endif
@objc(DeleteGroup) public class DeleteGroup : BaseObject,JHTTPCommand{
    ...
    required public init?(coder decoder: NSCoder) {
		...
		_groupId=String(decoder.decodeObjectOfClass(NSString.self, forKey: "_groupId")! as NSString)
    ...
    override public func encodeWithCoder(coder: NSCoder) {
		...
		coder.encodeObject(_groupId,forKey:"_groupId")
    ...
    - parameter groupId: the groupId concerned the operation
    ...
    */
    init (_ groupId:String=String(), fromDataSpace spaceUID:String,observableBy observationUID:String=Default.NOT_OBSERVABLE) {
    ...
    */
    static func commit(groupId:String, fromDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=DeleteGroup(groupId,fromDataSpace:spaceUID,observableBy:observationUID)
        operationInstance.commit()
    }


    func commit(){
        let context=Context(code:3927512040, caller: "DeleteGroup.commit")
        if let registry = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            //if registry.deleteById(self._groupId, fromCollectionWithName:"groups"){                // Prepare the operation
...
fromDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inDataSpace:spaceUID,withActionName:"DeleteGroup" ,forMethod:"DELETE", and: pathURL)
                ...
                r.responseString{ response in
                    ...
                    let context = JHTTPResponse( code: 4184959228,
                        caller: "DeleteGroup.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("deleteById  of group",
                            comment: "deleteById of group failure description")
