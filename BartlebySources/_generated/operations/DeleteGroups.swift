...
@objc(DeleteGroups) public class DeleteGroups : BaseObject,JHTTPCommand{
    ...
    */
    static func commit(ids:[String], fromDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=DeleteGroups(ids,fromDataSpace:spaceUID,observableBy:observationUID)
    ...
    func commit(){
        ...
        if let registry = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            //if registry.deleteByIds(self._ids, fromCollectionWithName:"groups"){                // Prepare the operation
...
fromDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                r.responseString{ response in
                    ...
                    let context = JHTTPResponse( code: 3182073104,
                        caller: "DeleteGroups.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("deleteByIds  of groups",
                            comment: "deleteByIds of groups failure description")
