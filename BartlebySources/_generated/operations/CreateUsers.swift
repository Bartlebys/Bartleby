...
import ObjectMapper
#endif
@objc(CreateUsers) public class CreateUsers : BaseObject,JHTTPCommand{
    ...
    required public init?(coder decoder: NSCoder) {
		...
		_users=decoder.decodeObjectOfClasses(NSSet(array: [NSArray.classForCoder(),User.classForCoder()]), forKey: "_users")! as! [User]
    ...
    override public func encodeWithCoder(coder: NSCoder) {
		...
		coder.encodeObject(_users,forKey:"_users")
    ...
    */
    init (_ users:[User]=[User](), inDataSpace spaceUID:String,observableBy observationUID:String=Default.NOT_OBSERVABLE) {
        self._users=users
    ...
    */
    static func commit(users:[User], inDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=CreateUsers(users,inDataSpace:spaceUID,observableBy:observationUID)
    ...
    func commit(){
        ...
        if let registry = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            //if registry.upsert(self._users){                // Prepare the operation
            ...
            if  self._operation.status==Operation.Status.Pending ||
                ...
                CreateUsers.execute(self._users,
                    ...
                    sucessHandler: { (context: JHTTPResponse) -> () in
                        registry.markAsDistributed(&self._users)
...
inDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inDataSpace:spaceUID,withActionName:"CreateUsers" ,forMethod:"POST", and: pathURL)
