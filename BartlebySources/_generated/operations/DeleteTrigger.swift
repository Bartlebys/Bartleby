...
@objc(DeleteTrigger) public class DeleteTrigger : BaseObject,JHTTPCommand{
    ...
    required public init?(coder decoder: NSCoder) {
		...
		_triggerId=String(decoder.decodeObjectOfClass(NSString.self, forKey: "_triggerId")! as NSString)
    ...
    override public func encodeWithCoder(coder: NSCoder) {
		...
		coder.encodeObject(_triggerId,forKey:"_triggerId")
    ...
    - parameter triggerId: the triggerId concerned the operation
    ...
    */
    init (_ triggerId:String=String(), fromDataSpace spaceUID:String,observableBy observationUID:String=Default.NOT_OBSERVABLE) {
    ...
    - parameter triggerId: the instance
    - parameter spaceUID:     the space UID
    - parameter oID:     the observable UID
    */
    static func commit(triggerId:String, fromDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=DeleteTrigger(triggerId,fromDataSpace:spaceUID,observableBy:observationUID)
        operationInstance.commit()
    }


    func commit(){
        let context=Context(code:2758021569, caller: "DeleteTrigger.commit")
        if let registry = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            //if registry.deleteById(self._triggerId, fromCollectionWithName:"triggers"){                // Prepare the operation
    ...
    public func push(sucessHandler success:(context:HTTPResponse)->(),
        ...
        if let _ = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            ...
            if  self._operation.status==Operation.Status.Pending ||
                ...
                DeleteTrigger.execute(self._triggerId,
                ...
                // This registry is not available there is nothing to do.
                let context=Context(code:2545308732, caller: "DeleteTrigger.push")
                Bartleby.sharedInstance.dispatchAdaptiveMessage(context,
    ...
    static public func execute(triggerId:String,
fromDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inDataSpace:spaceUID,withActionName:"DeleteTrigger" ,forMethod:"DELETE", and: pathURL)
                ...
                r.responseString{ response in
                    ...
                    let context = JHTTPResponse( code: 3146616210,
                        caller: "DeleteTrigger.execute",
                    ...
                    if result.isFailure {
                        let m = NSLocalizedString("deleteById  of trigger",
                            comment: "deleteById of trigger failure description")
