...
import ObjectMapper
#endif
@objc(UpdateUsers) public class UpdateUsers : BaseObject,JHTTPCommand{
    ...
    */
    static func commit(users:[User], inDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=UpdateUsers(users,inDataSpace:spaceUID,observableBy:observationUID)
...
inDataSpace spaceUID:String,
            ...
            failureHandler failure:(context:JHTTPResponse)->()){
                ...
                let urlRequest=HTTPManager.mutableRequestWithToken(inDataSpace:spaceUID,withActionName:"UpdateUsers" ,forMethod:"PUT", and: pathURL)
