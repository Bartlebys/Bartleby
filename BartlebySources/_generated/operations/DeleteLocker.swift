...
@objc(DeleteLocker) public class DeleteLocker : BaseObject,JHTTPCommand{
    ...
    required public init?(coder decoder: NSCoder) {
		...
		_lockerId=String(decoder.decodeObjectOfClass(NSString.self, forKey: "_lockerId")! as NSString)
    ...
    override public func encodeWithCoder(coder: NSCoder) {
		...
		coder.encodeObject(_lockerId,forKey:"_lockerId")
    ...
    */
    init (_ lockerId:String=String(), fromDataSpace spaceUID:String,observableBy observationUID:String=Default.NOT_OBSERVABLE) {
    ...
    */
    static func commit(lockerId:String, fromDataSpace spaceUID:String,observableBy observationUID:String){
        let operationInstance=DeleteLocker(lockerId,fromDataSpace:spaceUID,observableBy:observationUID)
    ...
    func commit(){
        ...
        if let registry = Bartleby.sharedInstance.getRegistryByUID(self._spaceUID) {
            //if registry.deleteById(self._lockerId, fromCollectionWithName:"lockers"){                // Prepare the operation
    ...
    static public func execute(lockerId:String,
