...
import ObjectMapper
#endif
@objc(ReadTriggersByQueryParameters) public class ReadTriggersByQueryParameters : BaseObject {
	// 
...
@objc(ReadTriggersByQuery) public class ReadTriggersByQuery : BaseObject{
